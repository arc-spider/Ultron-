 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Mg;function qS(){if(Mg)return ie;Mg=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),S=Symbol.for("react.activity"),y=Symbol.iterator;function M(U){return U===null||typeof U!="object"?null:(U=y&&U[y]||U["@@iterator"],typeof U=="function"?U:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,x={};function v(U,V,G){this.props=U,this.context=V,this.refs=x,this.updater=G||b}v.prototype.isReactComponent={},v.prototype.setState=function(U,V){if(typeof U!="object"&&typeof U!="function"&&U!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,U,V,"setState")},v.prototype.forceUpdate=function(U){this.updater.enqueueForceUpdate(this,U,"forceUpdate")};function L(){}L.prototype=v.prototype;function R(U,V,G){this.props=U,this.context=V,this.refs=x,this.updater=G||b}var O=R.prototype=new L;O.constructor=R,T(O,v.prototype),O.isPureReactComponent=!0;var X=Array.isArray;function I(){}var z={H:null,A:null,T:null,S:null},lt=Object.prototype.hasOwnProperty;function C(U,V,G){var Z=G.ref;return{$$typeof:o,type:U,key:V,ref:Z!==void 0?Z:null,props:G}}function N(U,V){return C(U.type,V,U.props)}function ot(U){return typeof U=="object"&&U!==null&&U.$$typeof===o}function ft(U){var V={"=":"=0",":":"=2"};return"$"+U.replace(/[=:]/g,function(G){return V[G]})}var Et=/\/+/g;function k(U,V){return typeof U=="object"&&U!==null&&U.key!=null?ft(""+U.key):V.toString(36)}function et(U){switch(U.status){case"fulfilled":return U.value;case"rejected":throw U.reason;default:switch(typeof U.status=="string"?U.then(I,I):(U.status="pending",U.then(function(V){U.status==="pending"&&(U.status="fulfilled",U.value=V)},function(V){U.status==="pending"&&(U.status="rejected",U.reason=V)})),U.status){case"fulfilled":return U.value;case"rejected":throw U.reason}}throw U}function P(U,V,G,Z,pt){var xt=typeof U;(xt==="undefined"||xt==="boolean")&&(U=null);var Tt=!1;if(U===null)Tt=!0;else switch(xt){case"bigint":case"string":case"number":Tt=!0;break;case"object":switch(U.$$typeof){case o:case e:Tt=!0;break;case _:return Tt=U._init,P(Tt(U._payload),V,G,Z,pt)}}if(Tt)return pt=pt(U),Tt=Z===""?"."+k(U,0):Z,X(pt)?(G="",Tt!=null&&(G=Tt.replace(Et,"$&/")+"/"),P(pt,V,G,"",function(vt){return vt})):pt!=null&&(ot(pt)&&(pt=N(pt,G+(pt.key==null||U&&U.key===pt.key?"":(""+pt.key).replace(Et,"$&/")+"/")+Tt)),V.push(pt)),1;Tt=0;var Xt=Z===""?".":Z+":";if(X(U))for(var mt=0;mt<U.length;mt++)Z=U[mt],xt=Xt+k(Z,mt),Tt+=P(Z,V,G,xt,pt);else if(mt=M(U),typeof mt=="function")for(U=mt.call(U),mt=0;!(Z=U.next()).done;)Z=Z.value,xt=Xt+k(Z,mt++),Tt+=P(Z,V,G,xt,pt);else if(xt==="object"){if(typeof U.then=="function")return P(et(U),V,G,Z,pt);throw V=String(U),Error("Objects are not valid as a React child (found: "+(V==="[object Object]"?"object with keys {"+Object.keys(U).join(", ")+"}":V)+"). If you meant to render a collection of children, use an array instead.")}return Tt}function q(U,V,G){if(U==null)return U;var Z=[],pt=0;return P(U,Z,"","",function(xt){return V.call(G,xt,pt++)}),Z}function Q(U){if(U._status===-1){var V=U._result;V=V(),V.then(function(G){(U._status===0||U._status===-1)&&(U._status=1,U._result=G)},function(G){(U._status===0||U._status===-1)&&(U._status=2,U._result=G)}),U._status===-1&&(U._status=0,U._result=V)}if(U._status===1)return U._result.default;throw U._result}var ct=typeof reportError=="function"?reportError:function(U){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var V=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof U=="object"&&U!==null&&typeof U.message=="string"?String(U.message):String(U),error:U});if(!window.dispatchEvent(V))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",U);return}console.error(U)},ut={map:q,forEach:function(U,V,G){q(U,function(){V.apply(this,arguments)},G)},count:function(U){var V=0;return q(U,function(){V++}),V},toArray:function(U){return q(U,function(V){return V})||[]},only:function(U){if(!ot(U))throw Error("React.Children.only expected to receive a single React element child.");return U}};return ie.Activity=S,ie.Children=ut,ie.Component=v,ie.Fragment=i,ie.Profiler=l,ie.PureComponent=R,ie.StrictMode=s,ie.Suspense=m,ie.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,ie.__COMPILER_RUNTIME={__proto__:null,c:function(U){return z.H.useMemoCache(U)}},ie.cache=function(U){return function(){return U.apply(null,arguments)}},ie.cacheSignal=function(){return null},ie.cloneElement=function(U,V,G){if(U==null)throw Error("The argument must be a React element, but you passed "+U+".");var Z=T({},U.props),pt=U.key;if(V!=null)for(xt in V.key!==void 0&&(pt=""+V.key),V)!lt.call(V,xt)||xt==="key"||xt==="__self"||xt==="__source"||xt==="ref"&&V.ref===void 0||(Z[xt]=V[xt]);var xt=arguments.length-2;if(xt===1)Z.children=G;else if(1<xt){for(var Tt=Array(xt),Xt=0;Xt<xt;Xt++)Tt[Xt]=arguments[Xt+2];Z.children=Tt}return C(U.type,pt,Z)},ie.createContext=function(U){return U={$$typeof:d,_currentValue:U,_currentValue2:U,_threadCount:0,Provider:null,Consumer:null},U.Provider=U,U.Consumer={$$typeof:u,_context:U},U},ie.createElement=function(U,V,G){var Z,pt={},xt=null;if(V!=null)for(Z in V.key!==void 0&&(xt=""+V.key),V)lt.call(V,Z)&&Z!=="key"&&Z!=="__self"&&Z!=="__source"&&(pt[Z]=V[Z]);var Tt=arguments.length-2;if(Tt===1)pt.children=G;else if(1<Tt){for(var Xt=Array(Tt),mt=0;mt<Tt;mt++)Xt[mt]=arguments[mt+2];pt.children=Xt}if(U&&U.defaultProps)for(Z in Tt=U.defaultProps,Tt)pt[Z]===void 0&&(pt[Z]=Tt[Z]);return C(U,xt,pt)},ie.createRef=function(){return{current:null}},ie.forwardRef=function(U){return{$$typeof:h,render:U}},ie.isValidElement=ot,ie.lazy=function(U){return{$$typeof:_,_payload:{_status:-1,_result:U},_init:Q}},ie.memo=function(U,V){return{$$typeof:p,type:U,compare:V===void 0?null:V}},ie.startTransition=function(U){var V=z.T,G={};z.T=G;try{var Z=U(),pt=z.S;pt!==null&&pt(G,Z),typeof Z=="object"&&Z!==null&&typeof Z.then=="function"&&Z.then(I,ct)}catch(xt){ct(xt)}finally{V!==null&&G.types!==null&&(V.types=G.types),z.T=V}},ie.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},ie.use=function(U){return z.H.use(U)},ie.useActionState=function(U,V,G){return z.H.useActionState(U,V,G)},ie.useCallback=function(U,V){return z.H.useCallback(U,V)},ie.useContext=function(U){return z.H.useContext(U)},ie.useDebugValue=function(){},ie.useDeferredValue=function(U,V){return z.H.useDeferredValue(U,V)},ie.useEffect=function(U,V){return z.H.useEffect(U,V)},ie.useEffectEvent=function(U){return z.H.useEffectEvent(U)},ie.useId=function(){return z.H.useId()},ie.useImperativeHandle=function(U,V,G){return z.H.useImperativeHandle(U,V,G)},ie.useInsertionEffect=function(U,V){return z.H.useInsertionEffect(U,V)},ie.useLayoutEffect=function(U,V){return z.H.useLayoutEffect(U,V)},ie.useMemo=function(U,V){return z.H.useMemo(U,V)},ie.useOptimistic=function(U,V){return z.H.useOptimistic(U,V)},ie.useReducer=function(U,V,G){return z.H.useReducer(U,V,G)},ie.useRef=function(U){return z.H.useRef(U)},ie.useState=function(U){return z.H.useState(U)},ie.useSyncExternalStore=function(U,V,G){return z.H.useSyncExternalStore(U,V,G)},ie.useTransition=function(){return z.H.useTransition()},ie.version="19.2.8",ie}var Eg;function Uh(){return Eg||(Eg=1,zf.exports=qS()),zf.exports}var he=Uh();const YS=n0(he);var Pf={exports:{}},yo={},Bf={exports:{}},If={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tg;function jS(){return Tg||(Tg=1,(function(o){function e(P,q){var Q=P.length;P.push(q);t:for(;0<Q;){var ct=Q-1>>>1,ut=P[ct];if(0<l(ut,q))P[ct]=q,P[Q]=ut,Q=ct;else break t}}function i(P){return P.length===0?null:P[0]}function s(P){if(P.length===0)return null;var q=P[0],Q=P.pop();if(Q!==q){P[0]=Q;t:for(var ct=0,ut=P.length,U=ut>>>1;ct<U;){var V=2*(ct+1)-1,G=P[V],Z=V+1,pt=P[Z];if(0>l(G,Q))Z<ut&&0>l(pt,G)?(P[ct]=pt,P[Z]=Q,ct=Z):(P[ct]=G,P[V]=Q,ct=V);else if(Z<ut&&0>l(pt,Q))P[ct]=pt,P[Z]=Q,ct=Z;else break t}}return q}function l(P,q){var Q=P.sortIndex-q.sortIndex;return Q!==0?Q:P.id-q.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var d=Date,h=d.now();o.unstable_now=function(){return d.now()-h}}var m=[],p=[],_=1,S=null,y=3,M=!1,b=!1,T=!1,x=!1,v=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,R=typeof setImmediate<"u"?setImmediate:null;function O(P){for(var q=i(p);q!==null;){if(q.callback===null)s(p);else if(q.startTime<=P)s(p),q.sortIndex=q.expirationTime,e(m,q);else break;q=i(p)}}function X(P){if(T=!1,O(P),!b)if(i(m)!==null)b=!0,I||(I=!0,ft());else{var q=i(p);q!==null&&et(X,q.startTime-P)}}var I=!1,z=-1,lt=5,C=-1;function N(){return x?!0:!(o.unstable_now()-C<lt)}function ot(){if(x=!1,I){var P=o.unstable_now();C=P;var q=!0;try{t:{b=!1,T&&(T=!1,L(z),z=-1),M=!0;var Q=y;try{e:{for(O(P),S=i(m);S!==null&&!(S.expirationTime>P&&N());){var ct=S.callback;if(typeof ct=="function"){S.callback=null,y=S.priorityLevel;var ut=ct(S.expirationTime<=P);if(P=o.unstable_now(),typeof ut=="function"){S.callback=ut,O(P),q=!0;break e}S===i(m)&&s(m),O(P)}else s(m);S=i(m)}if(S!==null)q=!0;else{var U=i(p);U!==null&&et(X,U.startTime-P),q=!1}}break t}finally{S=null,y=Q,M=!1}q=void 0}}finally{q?ft():I=!1}}}var ft;if(typeof R=="function")ft=function(){R(ot)};else if(typeof MessageChannel<"u"){var Et=new MessageChannel,k=Et.port2;Et.port1.onmessage=ot,ft=function(){k.postMessage(null)}}else ft=function(){v(ot,0)};function et(P,q){z=v(function(){P(o.unstable_now())},q)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(P){P.callback=null},o.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):lt=0<P?Math.floor(1e3/P):5},o.unstable_getCurrentPriorityLevel=function(){return y},o.unstable_next=function(P){switch(y){case 1:case 2:case 3:var q=3;break;default:q=y}var Q=y;y=q;try{return P()}finally{y=Q}},o.unstable_requestPaint=function(){x=!0},o.unstable_runWithPriority=function(P,q){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var Q=y;y=P;try{return q()}finally{y=Q}},o.unstable_scheduleCallback=function(P,q,Q){var ct=o.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?ct+Q:ct):Q=ct,P){case 1:var ut=-1;break;case 2:ut=250;break;case 5:ut=1073741823;break;case 4:ut=1e4;break;default:ut=5e3}return ut=Q+ut,P={id:_++,callback:q,priorityLevel:P,startTime:Q,expirationTime:ut,sortIndex:-1},Q>ct?(P.sortIndex=Q,e(p,P),i(m)===null&&P===i(p)&&(T?(L(z),z=-1):T=!0,et(X,Q-ct))):(P.sortIndex=ut,e(m,P),b||M||(b=!0,I||(I=!0,ft()))),P},o.unstable_shouldYield=N,o.unstable_wrapCallback=function(P){var q=y;return function(){var Q=y;y=q;try{return P.apply(this,arguments)}finally{y=Q}}}})(If)),If}var Ag;function ZS(){return Ag||(Ag=1,Bf.exports=jS()),Bf.exports}var Ff={exports:{}},En={};/**
 * @license React
...
}`;function tb(o,e,i){let s=new R0;const l=new be,u=new be,d=new yn,h=new KA({depthPacking:qy}),m=new QA,p={},_=i.maxTextureSize,S={[Ga]:Fn,[Fn]:Ga,[ta]:ta},y=new _r({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new be},radius:{value:4}},vertexShader:JA,fragmentShader:$A}),M=y.clone();M.defines.HORIZONTAL_PASS=1;const b=new Ti;b.setAttribute("position",new Ei(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new Mi(b,y),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=i0;let v=this.type;this.render=function(I,z,lt){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||I.length===0)return;const C=o.getRenderTarget(),N=o.getActiveCubeFace(),ot=o.getActiveMipmapLevel(),ft=o.state;ft.setBlending(Ia),ft.buffers.color.setClear(1,1,1,1),ft.buffers.depth.setTest(!0),ft.setScissorTest(!1);const Et=v!==$i&&this.type===$i,k=v===$i&&this.type!==$i;for(let et=0,P=I.length;et<P;et++){const q=I[et],Q=q.shadow;if(Q===void 0){console.warn("THREE.WebGLShadowMap:",q,"has no shadow.");continue}if(Q.autoUpdate===!1&&Q.needsUpdate===!1)continue;l.copy(Q.mapSize);const ct=Q.getFrameExtents();if(l.multiply(ct),u.copy(Q.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(u.x=Math.floor(_/ct.x),l.x=u.x*ct.x,Q.mapSize.x=u.x),l.y>_&&(u.y=Math.floor(_/ct.y),l.y=u.y*ct.y,Q.mapSize.y=u.y)),Q.map===null||Et===!0||k===!0){const U=this.type!==$i?{minFilter:wn,magFilter:wn}:{};Q.map!==null&&Q.map.dispose(),Q.map=new gr(l.x,l.y,U),Q.map.texture.name=q.name+".shadowMap",Q.camera.updateProjectionMatrix()}o.setRenderTarget(Q.map),o.clear();const ut=Q.getViewportCount();for(let U=0;U<ut;U++){const V=Q.getViewport(U);d.set(u.x*V.x,u.y*V.y,u.x*V.z,u.y*V.w),ft.viewport(d),Q.updateMatrices(q,U),s=Q.getFrustum(),O(z,lt,Q.camera,q,this.type)}Q.isPointLightShadow!==!0&&this.type===$i&&L(Q,lt),Q.needsUpdate=!1}v=this.type,x.needsUpdate=!1,o.setRenderTarget(C,N,ot)};function L(I,z){const lt=e.update(T);y.defines.VSM_SAMPLES!==I.blurSamples&&(y.defines.VSM_SAMPLES=I.blurSamples,M.defines.VSM_SAMPLES=I.blurSamples,y.needsUpdate=!0,M.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new gr(l.x,l.y)),y.uniforms.shadow_pass.value=I.map.texture,y.uniforms.resolution.value=I.mapSize,y.uniforms.radius.value=I.radius,o.setRenderTarget(I.mapPass),o.clear(),o.renderBufferDirect(z,null,lt,y,T,null),M.uniforms.shadow_pass.value=I.mapPass.texture,M.uniforms.resolution.value=I.mapSize,M.uniforms.radius.value=I.radius,o.setRenderTarget(I.map),o.clear(),o.renderBufferDirect(z,null,lt,M,T,null)}function R(I,z,lt,C){let N=null;const ot=lt.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(ot!==void 0)N=ot;else if(N=lt.isPointLight===!0?m:h,o.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0){const ft=N.uuid,Et=z.uuid;let k=p[ft];k===void 0&&(k={},p[ft]=k);let et=k[Et];et===void 0&&(et=N.clone(),k[Et]=et,z.addEventListener("dispose",X)),N=et}if(N.visible=z.visible,N.wireframe=z.wireframe,C===$i?N.side=z.shadowSide!==null?z.shadowSide:z.side:N.side=z.shadowSide!==null?z.shadowSide:S[z.side],N.alphaMap=z.alphaMap,N.alphaTest=z.alphaTest,N.map=z.map,N.clipShadows=z.clipShadows,N.clippingPlanes=z.clippingPlanes,N.clipIntersection=z.clipIntersection,N.displacementMap=z.displacementMap,N.displacementScale=z.displacementScale,N.displacementBias=z.displacementBias,N.wireframeLinewidth=z.wireframeLinewidth,N.linewidth=z.linewidth,lt.isPointLight===!0&&N.isMeshDistanceMaterial===!0){const ft=o.properties.get(N);ft.light=lt}return N}function O(I,z,lt,C,N){if(I.visible===!1)return;if(I.layers.test(z.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&N===$i)&&(!I.frustumCulled||s.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(lt.matrixWorldInverse,I.matrixWorld);const Et=e.update(I),k=I.material;if(Array.isArray(k)){const et=Et.groups;for(let P=0,q=et.length;P<q;P++){const Q=et[P],ct=k[Q.materialIndex];if(ct&&ct.visible){const ut=R(I,ct,C,N);I.onBeforeShadow(o,I,z,lt,Et,ut,Q),o.renderBufferDirect(lt,null,Et,ut,I,Q),I.onAfterShadow(o,I,z,lt,Et,ut,Q)}}}else if(k.visible){const et=R(I,k,C,N);I.onBeforeShadow(o,I,z,lt,Et,et,null),o.renderBufferDirect(lt,null,Et,et,I,null),I.onAfterShadow(o,I,z,lt,Et,et,null)}}const ft=I.children;for(let Et=0,k=ft.length;Et<k;Et++)O(ft[Et],z,lt,C,N)}function X(I){I.target.removeEventListener("dispose",X);for(const lt in p){const C=p[lt],N=I.target.uuid;N in C&&(C[N].dispose(),delete C[N])}}}function eb(o,e,i){const s=i.isWebGL2;function l(){let F=!1;const Ut=new yn;let Rt=null;const $t=new yn(0,0,0,0);return{setMask:function(jt){Rt!==jt&&!F&&(o.colorMask(jt,jt,jt,jt),Rt=jt)},setLocked:function(jt){F=jt},setClear:function(jt,Le,Re,We,je){je===!0&&(jt*=We,Le*=We,Re*=We),Ut.set(jt,Le,Re,We),$t.equals(Ut)===!1&&(o.clearColor(jt,Le,Re,We),$t.copy(Ut))},reset:function(){F=!1,Rt=null,$t.set(-1,0,0,0)}}}function u(){let F=!1,Ut=null,Rt=null,$t=null;return{setTest:function(jt){jt?mt(o.DEPTH_TEST):vt(o.DEPTH_TEST)},setMask:function(jt){Ut!==jt&&!F&&(o.depthMask(jt),Ut=jt)},setFunc:function(jt){if(Rt!==jt){switch(jt){case xy:o.depthFunc(o.NEVER);break;case My:o.depthFunc(o.ALWAYS);break;case Ey:o.depthFunc(o.LESS);break;case gc:o.depthFunc(o.LEQUAL);break;case Ty:o.depthFunc(o.EQUAL);break;case Ay:o.depthFunc(o.GEQUAL);break;case by:o.depthFunc(o.GREATER);break;case Ry:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Rt=jt}},setLocked:function(jt){F=jt},setClear:function(jt){$t!==jt&&(o.clearDepth(jt),$t=jt)},reset:function(){F=!1,Ut=null,Rt=null,$t=null}}}function d(){let F=!1,Ut=null,Rt=null,$t=null,jt=null,Le=null,Re=null,We=null,je=null;return{setTest:function(Ne){F||(Ne?mt(o.STENCIL_TEST):vt(o.STENCIL_TEST))},setMask:function(Ne){Ut!==Ne&&!F&&(o.stencilMask(Ne),Ut=Ne)},setFunc:function(Ne,un,Gn){(Rt!==Ne||$t!==un||jt!==Gn)&&(o.stencilFunc(Ne,un,Gn),Rt=Ne,$t=un,jt=Gn)},setOp:function(Ne,un,Gn){(Le!==Ne||Re!==un||We!==Gn)&&(o.stencilOp(Ne,un,Gn),Le=Ne,Re=un,We=Gn)},setLocked:function(Ne){F=Ne},setClear:function(Ne){je!==Ne&&(o.clearStencil(Ne),je=Ne)},reset:function(){F=!1,Ut=null,Rt=null,$t=null,jt=null,Le=null,Re=null,We=null,je=null}}}const h=new l,m=new u,p=new d,_=new WeakMap,S=new WeakMap;let y={},M={},b=new WeakMap,T=[],x=null,v=!1,L=null,R=null,O=null,X=null,I=null,z=null,lt=null,C=new De(0,0,0),N=0,ot=!1,ft=null,Et=null,k=null,et=null,P=null;const q=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Q=!1,ct=0;const ut=o.getParameter(o.VERSION);ut.indexOf("WebGL")!==-1?(ct=parseFloat(/^WebGL (\d)/.exec(ut)[1]),Q=ct>=1):ut.indexOf("OpenGL ES")!==-1&&(ct=parseFloat(/^OpenGL ES (\d)/.exec(ut)[1]),Q=ct>=2);let U=null,V={};const G=o.getParameter(o.SCISSOR_BOX),Z=o.getParameter(o.VIEWPORT),pt=new yn().fromArray(G),xt=new yn().fromArray(Z);function Tt(F,Ut,Rt,$t){const jt=new Uint8Array(4),Le=o.createTexture();o.bindTexture(F,Le),o.texParameteri(F,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(F,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Re=0;Re<Rt;Re++)s&&(F===o.TEXTURE_3D||F===o.TEXTURE_2D_ARRAY)?o.texImage3D(Ut,0,o.RGBA,1,1,$t,0,o.RGBA,o.UNSIGNED_BYTE,jt):o.texImage2D(Ut+Re,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,jt);return Le}const Xt={};Xt[o.TEXTURE_2D]=Tt(o.TEXTURE_2D,o.TEXTURE_2D,1),Xt[o.TEXTURE_CUBE_MAP]=Tt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),s&&(Xt[o.TEXTURE_2D_ARRAY]=Tt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),Xt[o.TEXTURE_3D]=Tt(o.TEXTURE_3D,o.TEXTURE_3D,1,1)),h.setClear(0,0,0,1),m.setClear(1),p.setClear(0),mt(o.DEPTH_TEST),m.setFunc(gc),Jt(!1),D(Ug),mt(o.CULL_FACE),zt(Ia);function mt(F){y[F]!==!0&&(o.enable(F),y[F]=!0)}function vt(F){y[F]!==!1&&(o.disable(F),y[F]=!1)}function Gt(F,Ut){return M[F]!==Ut?(o.bindFramebuffer(F,Ut),M[F]=Ut,s&&(F===o.DRAW_FRAMEBUFFER&&(M[o.FRAMEBUFFER]=Ut),F===o.FRAMEBUFFER&&(M[o.DRAW_FRAMEBUFFER]=Ut)),!0):!1}function Y(F,Ut){let Rt=T,$t=!1;if(F)if(Rt=b.get(Ut),Rt===void 0&&(Rt=[],b.set(Ut,Rt)),F.isWebGLMultipleRenderTargets){const jt=F.texture;if(Rt.length!==jt.length||Rt[0]!==o.COLOR_ATTACHMENT0){for(let Le=0,Re=jt.length;Le<Re;Le++)Rt[Le]=o.COLOR_ATTACHMENT0+Le;Rt.length=jt.length,$t=!0}}else Rt[0]!==o.COLOR_ATTACHMENT0&&(Rt[0]=o.COLOR_ATTACHMENT0,$t=!0);else Rt[0]!==o.BACK&&(Rt[0]=o.BACK,$t=!0);$t&&(i.isWebGL2?o.drawBuffers(Rt):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(Rt))}function fe(F){return x!==F?(o.useProgram(F),x=F,!0):!1}const Lt={[fr]:o.FUNC_ADD,[sy]:o.FUNC_SUBTRACT,[oy]:o.FUNC_REVERSE_SUBTRACT};if(s)Lt[Ng]=o.MIN,Lt[Og]=o.MAX;else{const F=e.get("EXT_blend_minmax");F!==null&&(Lt[Ng]=F.MIN_EXT,Lt[Og]=F.MAX_EXT)}const Pt={[ly]:o.ZERO,[cy]:o.ONE,[uy]:o.SRC_COLOR,[Sh]:o.SRC_ALPHA,[gy]:o.SRC_ALPHA_SATURATE,[py]:o.DST_COLOR,[hy]:o.DST_ALPHA,[fy]:o.ONE_MINUS_SRC_COLOR,[yh]:o.ONE_MINUS_SRC_ALPHA,[my]:o.ONE_MINUS_DST_COLOR,[dy]:o.ONE_MINUS_DST_ALPHA,[_y]:o.CONSTANT_COLOR,[vy]:o.ONE_MINUS_CONSTANT_COLOR,[Sy]:o.CONSTANT_ALPHA,[yy]:o.ONE_MINUS_CONSTANT_ALPHA};function zt(F,Ut,Rt,$t,jt,Le,Re,We,je,Ne){if(F===Ia){v===!0&&(vt(o.BLEND),v=!1);return}if(v===!1&&(mt(o.BLEND),v=!0),F!==ry){if(F!==L||Ne!==ot){if((R!==fr||I!==fr)&&(o.blendEquation(o.FUNC_ADD),R=fr,I=fr),Ne)switch(F){case gs:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case vh:o.blendFunc(o.ONE,o.ONE);break;case Dg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case Lg:o.blendFuncSeparate(o.ZERO,o.SRC_COLOR,o.ZERO,o.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case gs:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case vh:o.blendFunc(o.SRC_ALPHA,o.ONE);break;case Dg:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case Lg:o.blendFunc(o.ZERO,o.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}O=null,X=null,z=null,lt=null,C.set(0,0,0),N=0,L=F,ot=Ne}return}jt=jt||Ut,Le=Le||Rt,Re=Re||$t,(Ut!==R||jt!==I)&&(o.blendEquationSeparate(Lt[Ut],Lt[jt]),R=Ut,I=jt),(Rt!==O||$t!==X||Le!==z||Re!==lt)&&(o.blendFuncSeparate(Pt[Rt],Pt[$t],Pt[Le],Pt[Re]),O=Rt,X=$t,z=Le,lt=Re),(We.equals(C)===!1||je!==N)&&(o.blendColor(We.r,We.g,We.b,je),C.copy(We),N=je),L=F,ot=!1}function Te(F,Ut){F.side===ta?vt(o.CULL_FACE):mt(o.CULL_FACE);let Rt=F.side===Fn;Ut&&(Rt=!Rt),Jt(Rt),F.blending===gs&&F.transparent===!1?zt(Ia):zt(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),m.setFunc(F.depthFunc),m.setTest(F.depthTest),m.setMask(F.depthWrite),h.setMask(F.colorWrite);const $t=F.stencilWrite;p.setTest($t),$t&&(p.setMask(F.stencilWriteMask),p.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),p.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),J(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?mt(o.SAMPLE_ALPHA_TO_COVERAGE):vt(o.SAMPLE_ALPHA_TO_COVERAGE)}function Jt(F){ft!==F&&(F?o.frontFace(o.CW):o.frontFace(o.CCW),ft=F)}function D(F){F!==ny?(mt(o.CULL_FACE),F!==Et&&(F===Ug?o.cullFace(o.BACK):F===iy?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):vt(o.CULL_FACE),Et=F}function A(F){F!==k&&(Q&&o.lineWidth(F),k=F)}function J(F,Ut,Rt){F?(mt(o.POLYGON_OFFSET_FILL),(et!==Ut||P!==Rt)&&(o.polygonOffset(Ut,Rt),et=Ut,P=Rt)):vt(o.POLYGON_OFFSET_FILL)}function Mt(F){F?mt(o.SCISSOR_TEST):vt(o.SCISSOR_TEST)}function St(F){F===void 0&&(F=o.TEXTURE0+q-1),U!==F&&(o.activeTexture(F),U=F)}function _t(F,Ut,Rt){Rt===void 0&&(U===null?Rt=o.TEXTURE0+q-1:Rt=U);let $t=V[Rt];$t===void 0&&($t={type:void 0,texture:void 0},V[Rt]=$t),($t.type!==F||$t.texture!==Ut)&&(U!==Rt&&(o.activeTexture(Rt),U=Rt),o.bindTexture(F,Ut||Xt[F]),$t.type=F,$t.texture=Ut)}function It(){const F=V[U];F!==void 0&&F.type!==void 0&&(o.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function wt(){try{o.compressedTexImage2D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ft(){try{o.compressedTexImage3D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Yt(){try{o.texSubImage2D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ae(){try{o.texSubImage3D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function yt(){try{o.compressedTexSubImage2D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function xe(){try{o.compressedTexSubImage3D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function re(){try{o.texStorage2D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ot(){try{o.texStorage3D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function bt(){try{o.texImage2D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Dt(){try{o.texImage3D.apply(o,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Bt(F){pt.equals(F)===!1&&(o.scissor(F.x,F.y,F.z,F.w),pt.copy(F))}function pe(F){xt.equals(F)===!1&&(o.viewport(F.x,F.y,F.z,F.w),xt.copy(F))}function ye(F,Ut){let Rt=S.get(Ut);Rt===void 0&&(Rt=new WeakMap,S.set(Ut,Rt));let $t=Rt.get(F);$t===void 0&&($t=o.getUniformBlockIndex(Ut,F.name),Rt.set(F,$t))}function se(F,Ut){const $t=S.get(Ut).get(F);_.get(Ut)!==$t&&(o.uniformBlockBinding(Ut,$t,F.__bindingPointIndex),_.set(Ut,$t))}function At(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),s===!0&&(o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null)),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),y={},U=null,V={},M={},b=new WeakMap,T=[],x=null,v=!1,L=null,R=null,O=null,X=null,I=null,z=null,lt=null,C=new De(0,0,0),N=0,ot=!1,ft=null,Et=null,k=null,et=null,P=null,pt.set(0,0,o.canvas.width,o.canvas.height),xt.set(0,0,o.canvas.width,o.canvas.height),h.reset(),m.reset(),p.reset()}return{buffers:{color:h,depth:m,stencil:p},enable:mt,disable:vt,bindFramebuffer:Gt,drawBuffers:Y,useProgram:fe,setBlending:zt,setMaterial:Te,setFlipSided:Jt,setCullFace:D,setLineWidth:A,setPolygonOffset:J,setScissorTest:Mt,activeTexture:St,bindTexture:_t,unbindTexture:It,compressedTexImage2D:wt,compressedTexImage3D:Ft,texImage2D:bt,texImage3D:Dt,updateUBOMapping:ye,uniformBlockBinding:se,texStorage2D:re,texStorage3D:Ot,texSubImage2D:Yt,texSubImage3D:ae,compressedTexSubImage2D:yt,compressedTexSubImage3D:xe,scissor:Bt,viewport:pe,reset:At}}function nb(o,e,i,s,l,u,d){const h=l.isWebGL2,m=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),_=new WeakMap;let S;const y=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(D,A){return M?new OffscreenCanvas(D,A):xc("canvas")}function T(D,A,J,Mt){let St=1;if((D.width>Mt||D.height>Mt)&&(St=Mt/Math.max(D.width,D.height)),St<1||A===!0)if(typeof HTMLImageElement<"u"&&D instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&D instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&D instanceof ImageBitmap){const _t=A?Rh:Math.floor,It=_t(St*D.width),wt=_t(St*D.height);S===void 0&&(S=b(It,wt));const Ft=J?b(It,wt):S;return Ft.width=It,Ft.height=wt,Ft.getContext("2d").drawImage(D,0,0,It,wt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+D.width+"x"+D.height+") to ("+It+"x"+wt+")."),Ft}else return"data"in D&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+D.width+"x"+D.height+")."),D;return D}function x(D){return u_(D.width)&&u_(D.height)}function v(D){return h?!1:D.wrapS!==yi||D.wrapT!==yi||D.minFilter!==wn&&D.minFilter!==ci}function L(D,A){return D.generateMipmaps&&A&&D.minFilter!==wn&&D.minFilter!==ci}function R(D){o.generateMipmap(D)}function O(D,A,J,Mt,St=!1){if(h===!1)return A;if(D!==null){if(o[D]!==void 0)return o[D];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+D+"'")}let _t=A;if(A===o.RED&&(J===o.FLOAT&&(_t=o.R32F),J===o.HALF_FLOAT&&(_t=o.R16F),J===o.UNSIGNED_BYTE&&(_t=o.R8)),A===o.RED_INTEGER&&(J===o.UNSIGNED_BYTE&&(_t=o.R8UI),J===o.UNSIGNED_SHORT&&(_t=o.R16UI),J===o.UNSIGNED_INT&&(_t=o.R32UI),J===o.BYTE&&(_t=o.R8I),J===o.SHORT&&(_t=o.R16I),J===o.INT&&(_t=o.R32I)),A===o.RG&&(J===o.FLOAT&&(_t=o.RG32F),J===o.HALF_FLOAT&&(_t=o.RG16F),J===o.UNSIGNED_BYTE&&(_t=o.RG8)),A===o.RGBA){const It=St?_c:Be.getTransfer(Mt);J===o.FLOAT&&(_t=o.RGBA32F),J===o.HALF_FLOAT&&(_t=o.RGBA16F),J===o.UNSIGNED_BYTE&&(_t=It===ke?o.SRGB8_ALPHA8:o.RGBA8),J===o.UNSIGNED_SHORT_4_4_4_4&&(_t=o.RGBA4),J===o.UNSIGNED_SHORT_5_5_5_1&&(_t=o.RGB5_A1)}return(_t===o.R16F||_t===o.R32F||_t===o.RG16F||_t===o.RG32F||_t===o.RGBA16F||_t===o.RGBA32F)&&e.get("EXT_color_buffer_float"),_t}function X(D,A,J){return L(D,J)===!0||D.isFramebufferTexture&&D.minFilter!==wn&&D.minFilter!==ci?Math.log2(Math.max(A.width,A.height))+1:D.mipmaps!==void 0&&D.mipmaps.length>0?D.mipmaps.length:D.isCompressedTexture&&Array.isArray(D.image)?A.mipmaps.length:1}function I(D){return D===wn||D===zg||D===Hf?o.NEAREST:o.LINEAR}function z(D){const A=D.target;A.removeEventListener("dispose",z),C(A),A.isVideoTexture&&_.delete(A)}function lt(D){const A=D.target;A.removeEventListener("dispose",lt),ot(A)}function C(D){const A=s.get(D);if(A.__webglInit===void 0)return;const J=D.source,Mt=y.get(J);if(Mt){const St=Mt[A.__cacheKey];St.usedTimes--,St.usedTimes===0&&N(D),Object.keys(Mt).length===0&&y.delete(J)}s.remove(D)}function N(D){const A=s.get(D);o.deleteTexture(A.__webglTexture);const J=D.source,Mt=y.get(J);delete Mt[A.__cacheKey],d.memory.textures--}function ot(D){const A=D.texture,J=s.get(D),Mt=s.get(A);if(Mt.__webglTexture!==void 0&&(o.deleteTexture(Mt.__webglTexture),d.memory.textures--),D.depthTexture&&D.depthTexture.dispose(),D.isWebGLCubeRenderTarget)for(let St=0;St<6;St++){if(Array.isArray(J.__webglFramebuffer[St]))for(let _t=0;_t<J.__webglFramebuffer[St].length;_t++)o.deleteFramebuffer(J.__webglFramebuffer[St][_t]);else o.deleteFramebuffer(J.__webglFramebuffer[St]);J.__webglDepthbuffer&&o.deleteRenderbuffer(J.__webglDepthbuffer[St])}else{if(Array.isArray(J.__webglFramebuffer))for(let St=0;St<J.__webglFramebuffer.length;St++)o.deleteFramebuffer(J.__webglFramebuffer[St]);else o.deleteFramebuffer(J.__webglFramebuffer);if(J.__webglDepthbuffer&&o.deleteRenderbuffer(J.__webglDepthbuffer),J.__webglMultisampledFramebuffer&&o.deleteFramebuffer(J.__webglMultisampledFramebuffer),J.__webglColorRenderbuffer)for(let St=0;St<J.__webglColorRenderbuffer.length;St++)J.__webglColorRenderbuffer[St]&&o.deleteRenderbuffer(J.__webglColorRenderbuffer[St]);J.__webglDepthRenderbuffer&&o.deleteRenderbuffer(J.__webglDepthRenderbuffer)}if(D.isWebGLMultipleRenderTargets)for(let St=0,_t=A.length;St<_t;St++){const It=s.get(A[St]);It.__webglTexture&&(o.deleteTexture(It.__webglTexture),d.memory.textures--),s.remove(A[St])}s.remove(A),s.remove(D)}let ft=0;function Et(){ft=0}function k(){const D=ft;return D>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+D+" texture units while this GPU supports only "+l.maxTextures),ft+=1,D}function et(D){const A=[];return A.push(D.wrapS),A.push(D.wrapT),A.push(D.wrapR||0),A.push(D.magFilter),A.push(D.minFilter),A.push(D.anisotropy),A.push(D.internalFormat),A.push(D.format),A.push(D.type),A.push(D.generateMipmaps),A.push(D.premultiplyAlpha),A.push(D.flipY),A.push(D.unpackAlignment),A.push(D.colorSpace),A.join()}function P(D,A){const J=s.get(D);if(D.isVideoTexture&&Te(D),D.isRenderTargetTexture===!1&&D.version>0&&J.__version!==D.version){const Mt=D.image;if(Mt===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Mt.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{pt(J,D,A);return}}i.bindTexture(o.TEXTURE_2D,J.__webglTexture,o.TEXTURE0+A)}function q(D,A){const J=s.get(D);if(D.version>0&&J.__version!==D.version){pt(J,D,A);return}i.bindTexture(o.TEXTURE_2D_ARRAY,J.__webglTexture,o.TEXTURE0+A)}function Q(D,A){const J=s.get(D);if(D.version>0&&J.__version!==D.version){pt(J,D,A);return}i.bindTexture(o.TEXTURE_3D,J.__webglTexture,o.TEXTURE0+A)}function ct(D,A){const J=s.get(D);if(D.version>0&&J.__version!==D.version){xt(J,D,A);return}i.bindTexture(o.TEXTURE_CUBE_MAP,J.__webglTexture,o.TEXTURE0+A)}const ut={[Eh]:o.REPEAT,[yi]:o.CLAMP_TO_EDGE,[Th]:o.MIRRORED_REPEAT},U={[wn]:o.NEAREST,[zg]:o.NEAREST_MIPMAP_NEAREST,[Hf]:o.NEAREST_MIPMAP_LINEAR,[ci]:o.LINEAR,[Py]:o.LINEAR_MIPMAP_NEAREST,[Co]:o.LINEAR_MIPMAP_LINEAR},V={[Zy]:o.NEVER,[ex]:o.ALWAYS,[Ky]:o.LESS,[p0]:o.LEQUAL,[Qy]:o.EQUAL,[tx]:o.GEQUAL,[Jy]:o.GREATER,[$y]:o.NOTEQUAL};function G(D,A,J){if(J?(o.texParameteri(D,o.TEXTURE_WRAP_S,ut[A.wrapS]),o.texParameteri(D,o.TEXTURE_WRAP_T,ut[A.wrapT]),(D===o.TEXTURE_3D||D===o.TEXTURE_2D_ARRAY)&&o.texParameteri(D,o.TEXTURE_WRAP_R,ut[A.wrapR]),o.texParameteri(D,o.TEXTURE_MAG_FILTER,U[A.magFilter]),o.texParameteri(D,o.TEXTURE_MIN_FILTER,U[A.minFilter])):(o.texParameteri(D,o.TEXTURE_WRAP_S,o.CLAMP_TO_EDGE),o.texParameteri(D,o.TEXTURE_WRAP_T,o.CLAMP_TO_EDGE),(D===o.TEXTURE_3D||D===o.TEXTURE_2D_ARRAY)&&o.texParameteri(D,o.TEXTURE_WRAP_R,o.CLAMP_TO_EDGE),(A.wrapS!==yi||A.wrapT!==yi)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),o.texParameteri(D,o.TEXTURE_MAG_FILTER,I(A.magFilter)),o.texParameteri(D,o.TEXTURE_MIN_FILTER,I(A.minFilter)),A.minFilter!==wn&&A.minFilter!==ci&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),A.compareFunction&&(o.texParameteri(D,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(D,o.TEXTURE_COMPARE_FUNC,V[A.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const Mt=e.get("EXT_texture_filter_anisotropic");if(A.magFilter===wn||A.minFilter!==Hf&&A.minFilter!==Co||A.type===Ba&&e.has("OES_texture_float_linear")===!1||h===!1&&A.type===wo&&e.has("OES_texture_half_float_linear")===!1)return;(A.anisotropy>1||s.get(A).__currentAnisotropy)&&(o.texParameterf(D,Mt.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,l.getMaxAnisotropy())),s.get(A).__currentAnisotropy=A.anisotropy)}}function Z(D,A){let J=!1;D.__webglInit===void 0&&(D.__webglInit=!0,A.addEventListener("dispose",z));const Mt=A.source;let St=y.get(Mt);St===void 0&&(St={},y.set(Mt,St));const _t=et(A);if(_t!==D.__cacheKey){St[_t]===void 0&&(St[_t]={texture:o.createTexture(),usedTimes:0},d.memory.textures++,J=!0),St[_t].usedTimes++;const It=St[D.__cacheKey];It!==void 0&&(St[D.__cacheKey].usedTimes--,It.usedTimes===0&&N(A)),D.__cacheKey=_t,D.__webglTexture=St[_t].texture}return J}function pt(D,A,J){let Mt=o.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&(Mt=o.TEXTURE_2D_ARRAY),A.isData3DTexture&&(Mt=o.TEXTURE_3D);const St=Z(D,A),_t=A.source;i.bindTexture(Mt,D.__webglTexture,o.TEXTURE0+J);const It=s.get(_t);if(_t.version!==It.__version||St===!0){i.activeTexture(o.TEXTURE0+J);const wt=Be.getPrimaries(Be.workingColorSpace),Ft=A.colorSpace===fi?null:Be.getPrimaries(A.colorSpace),Yt=A.colorSpace===fi||wt===Ft?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,A.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,A.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Yt);const ae=v(A)&&x(A.image)===!1;let yt=T(A.image,ae,!1,l.maxTextureSize);yt=Jt(A,yt);const xe=x(yt)||h,re=u.convert(A.format,A.colorSpace);let Ot=u.convert(A.type),bt=O(A.internalFormat,re,Ot,A.colorSpace,A.isVideoTexture);G(Mt,A,xe);let Dt;const Bt=A.mipmaps,pe=h&&A.isVideoTexture!==!0&&bt!==h0,ye=It.__version===void 0||St===!0,se=X(A,yt,xe);if(A.isDepthTexture)bt=o.DEPTH_COMPONENT,h?A.type===Ba?bt=o.DEPTH_COMPONENT32F:A.type===Pa?bt=o.DEPTH_COMPONENT24:A.type===dr?bt=o.DEPTH24_STENCIL8:bt=o.DEPTH_COMPONENT16:A.type===Ba&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),A.format===pr&&bt===o.DEPTH_COMPONENT&&A.type!==Lh&&A.type!==Pa&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),A.type=Pa,Ot=u.convert(A.type)),A.format===ys&&bt===o.DEPTH_COMPONENT&&(bt=o.DEPTH_STENCIL,A.type!==dr&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),A.type=dr,Ot=u.convert(A.type))),ye&&(pe?i.texStorage2D(o.TEXTURE_2D,1,bt,yt.width,yt.height):i.texImage2D(o.TEXTURE_2D,0,bt,yt.width,yt.height,0,re,Ot,null));else if(A.isDataTexture)if(Bt.length>0&&xe){pe&&ye&&i.texStorage2D(o.TEXTURE_2D,se,bt,Bt[0].width,Bt[0].height);for(let At=0,F=Bt.length;At<F;At++)Dt=Bt[At],pe?i.texSubImage2D(o.TEXTURE_2D,At,0,0,Dt.width,Dt.height,re,Ot,Dt.data):i.texImage2D(o.TEXTURE_2D,At,bt,Dt.width,Dt.height,0,re,Ot,Dt.data);A.generateMipmaps=!1}else pe?(ye&&i.texStorage2D(o.TEXTURE_2D,se,bt,yt.width,yt.height),i.texSubImage2D(o.TEXTURE_2D,0,0,0,yt.width,yt.height,re,Ot,yt.data)):i.texImage2D(o.TEXTURE_2D,0,bt,yt.width,yt.height,0,re,Ot,yt.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){pe&&ye&&i.texStorage3D(o.TEXTURE_2D_ARRAY,se,bt,Bt[0].width,Bt[0].height,yt.depth);for(let At=0,F=Bt.length;At<F;At++)Dt=Bt[At],A.format!==xi?re!==null?pe?i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,At,0,0,0,Dt.width,Dt.height,yt.depth,re,Dt.data,0,0):i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,At,bt,Dt.width,Dt.height,yt.depth,0,Dt.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):pe?i.texSubImage3D(o.TEXTURE_2D_ARRAY,At,0,0,0,Dt.width,Dt.height,yt.depth,re,Ot,Dt.data):i.texImage3D(o.TEXTURE_2D_ARRAY,At,bt,Dt.width,Dt.height,yt.depth,0,re,Ot,Dt.data)}else{pe&&ye&&i.texStorage2D(o.TEXTURE_2D,se,bt,Bt[0].width,Bt[0].height);for(let At=0,F=Bt.length;At<F;At++)Dt=Bt[At],A.format!==xi?re!==null?pe?i.compressedTexSubImage2D(o.TEXTURE_2D,At,0,0,Dt.width,Dt.height,re,Dt.data):i.compressedTexImage2D(o.TEXTURE_2D,At,bt,Dt.width,Dt.height,0,Dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):pe?i.texSubImage2D(o.TEXTURE_2D,At,0,0,Dt.width,Dt.height,re,Ot,Dt.data):i.texImage2D(o.TEXTURE_2D,At,bt,Dt.width,Dt.height,0,re,Ot,Dt.data)}else if(A.isDataArrayTexture)pe?(ye&&i.texStorage3D(o.TEXTURE_2D_ARRAY,se,bt,yt.width,yt.height,yt.depth),i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,yt.width,yt.height,yt.depth,re,Ot,yt.data)):i.texImage3D(o.TEXTURE_2D_ARRAY,0,bt,yt.width,yt.height,yt.depth,0,re,Ot,yt.data);else if(A.isData3DTexture)pe?(ye&&i.texStorage3D(o.TEXTURE_3D,se,bt,yt.width,yt.height,yt.depth),i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,yt.width,yt.height,yt.depth,re,Ot,yt.data)):i.texImage3D(o.TEXTURE_3D,0,bt,yt.width,yt.height,yt.depth,0,re,Ot,yt.data);else if(A.isFramebufferTexture){if(ye)if(pe)i.texStorage2D(o.TEXTURE_2D,se,bt,yt.width,yt.height);else{let At=yt.width,F=yt.height;for(let Ut=0;Ut<se;Ut++)i.texImage2D(o.TEXTURE_2D,Ut,bt,At,F,0,re,Ot,null),At>>=1,F>>=1}}else if(Bt.length>0&&xe){pe&&ye&&i.texStorage2D(o.TEXTURE_2D,se,bt,Bt[0].width,Bt[0].height);for(let At=0,F=Bt.length;At<F;At++)Dt=Bt[At],pe?i.texSubImage2D(o.TEXTURE_2D,At,0,0,re,Ot,Dt):i.texImage2D(o.TEXTURE_2D,At,bt,re,Ot,Dt);A.generateMipmaps=!1}else pe?(ye&&i.texStorage2D(o.TEXTURE_2D,se,bt,yt.width,yt.height),i.texSubImage2D(o.TEXTURE_2D,0,0,0,re,Ot,yt)):i.texImage2D(o.TEXTURE_2D,0,bt,re,Ot,yt);L(A,xe)&&R(Mt),It.__version=_t.version,A.onUpdate&&A.onUpdate(A)}D.__version=A.version}function xt(D,A,J){if(A.image.length!==6)return;const Mt=Z(D,A),St=A.source;i.bindTexture(o.TEXTURE_CUBE_MAP,D.__webglTexture,o.TEXTURE0+J);const _t=s.get(St);if(St.version!==_t.__version||Mt===!0){i.activeTexture(o.TEXTURE0+J);const It=Be.getPrimaries(Be.workingColorSpace),wt=A.colorSpace===fi?null:Be.getPrimaries(A.colorSpace),Ft=A.colorSpace===fi||It===wt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,A.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,A.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ft);const Yt=A.isCompressedTexture||A.image[0].isCompressedTexture,ae=A.image[0]&&A.image[0].isDataTexture,yt=[];for(let At=0;At<6;At++)!Yt&&!ae?yt[At]=T(A.image[At],!1,!0,l.maxCubemapSize):yt[At]=ae?A.image[At].image:A.image[At],yt[At]=Jt(A,yt[At]);const xe=yt[0],re=x(xe)||h,Ot=u.convert(A.format,A.colorSpace),bt=u.convert(A.type),Dt=O(A.internalFormat,Ot,bt,A.colorSpace),Bt=h&&A.isVideoTexture!==!0,pe=_t.__version===void 0||Mt===!0;let ye=X(A,xe,re);G(o.TEXTURE_CUBE_MAP,A,re);let se;if(Yt){Bt&&pe&&i.texStorage2D(o.TEXTURE_CUBE_MAP,ye,Dt,xe.width,xe.height);for(let At=0;At<6;At++){se=yt[At].mipmaps;for(let F=0;F<se.length;F++){const Ut=se[F];A.format!==xi?Ot!==null?Bt?i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,F,0,0,Ut.width,Ut.height,Ot,Ut.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,F,Dt,Ut.width,Ut.height,0,Ut.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Bt?i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,F,0,0,Ut.width,Ut.height,Ot,bt,Ut.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,F,Dt,Ut.width,Ut.height,0,Ot,bt,Ut.data)}}}else{se=A.mipmaps,Bt&&pe&&(se.length>0&&ye++,i.texStorage2D(o.TEXTURE_CUBE_MAP,ye,Dt,yt[0].width,yt[0].height));for(let At=0;At<6;At++)if(ae){Bt?i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,0,0,0,yt[At].width,yt[At].height,Ot,bt,yt[At].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,0,Dt,yt[At].width,yt[At].height,0,Ot,bt,yt[At].data);for(let F=0;F<se.length;F++){const Rt=se[F].image[At].image;Bt?i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,F+1,0,0,Rt.width,Rt.height,Ot,bt,Rt.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,F+1,Dt,Rt.width,Rt.height,0,Ot,bt,Rt.data)}}else{Bt?i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,0,0,0,Ot,bt,yt[At]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,0,Dt,Ot,bt,yt[At]);for(let F=0;F<se.length;F++){const Ut=se[F];Bt?i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,F+1,0,0,Ot,bt,Ut.image[At]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+At,F+1,Dt,Ot,bt,Ut.image[At])}}}L(A,re)&&R(o.TEXTURE_CUBE_MAP),_t.__version=St.version,A.onUpdate&&A.onUpdate(A)}D.__version=A.version}function Tt(D,A,J,Mt,St,_t){const It=u.convert(J.format,J.colorSpace),wt=u.convert(J.type),Ft=O(J.internalFormat,It,wt,J.colorSpace);if(!s.get(A).__hasExternalTextures){const ae=Math.max(1,A.width>>_t),yt=Math.max(1,A.height>>_t);St===o.TEXTURE_3D||St===o.TEXTURE_2D_ARRAY?i.texImage3D(St,_t,Ft,ae,yt,A.depth,0,It,wt,null):i.texImage2D(St,_t,Ft,ae,yt,0,It,wt,null)}i.bindFramebuffer(o.FRAMEBUFFER,D),zt(A)?m.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Mt,St,s.get(J).__webglTexture,0,Pt(A)):(St===o.TEXTURE_2D||St>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&St<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,Mt,St,s.get(J).__webglTexture,_t),i.bindFramebuffer(o.FRAMEBUFFER,null)}function Xt(D,A,J){if(o.bindRenderbuffer(o.RENDERBUFFER,D),A.depthBuffer&&!A.stencilBuffer){let Mt=h===!0?o.DEPTH_COMPONENT24:o.DEPTH_COMPONENT16;if(J||zt(A)){const St=A.depthTexture;St&&St.isDepthTexture&&(St.type===Ba?Mt=o.DEPTH_COMPONENT32F:St.type===Pa&&(Mt=o.DEPTH_COMPONENT24));const _t=Pt(A);zt(A)?m.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,_t,Mt,A.width,A.height):o.renderbufferStorageMultisample(o.RENDERBUFFER,_t,Mt,A.width,A.height)}else o.renderbufferStorage(o.RENDERBUFFER,Mt,A.width,A.height);o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.RENDERBUFFER,D)}else if(A.depthBuffer&&A.stencilBuffer){const Mt=Pt(A);J&&zt(A)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,Mt,o.DEPTH24_STENCIL8,A.width,A.height):zt(A)?m.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Mt,o.DEPTH24_STENCIL8,A.width,A.height):o.renderbufferStorage(o.RENDERBUFFER,o.DEPTH_STENCIL,A.width,A.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.RENDERBUFFER,D)}else{const Mt=A.isWebGLMultipleRenderTargets===!0?A.texture:[A.texture];for(let St=0;St<Mt.length;St++){const _t=Mt[St],It=u.convert(_t.format,_t.colorSpace),wt=u.convert(_t.type),Ft=O(_t.internalFormat,It,wt,_t.colorSpace),Yt=Pt(A);J&&zt(A)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,Yt,Ft,A.width,A.height):zt(A)?m.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Yt,Ft,A.width,A.height):o.renderbufferStorage(o.RENDERBUFFER,Ft,A.width,A.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function mt(D,A){if(A&&A.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,D),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!s.get(A.depthTexture).__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),P(A.depthTexture,0);const Mt=s.get(A.depthTexture).__webglTexture,St=Pt(A);if(A.depthTexture.format===pr)zt(A)?m.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Mt,0,St):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,Mt,0);else if(A.depthTexture.format===ys)zt(A)?m.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Mt,0,St):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,Mt,0);else throw new Error("Unknown depthTexture format")}function vt(D){const A=s.get(D),J=D.isWebGLCubeRenderTarget===!0;if(D.depthTexture&&!A.__autoAllocateDepthBuffer){if(J)throw new Error("target.depthTexture not supported in Cube render targets");mt(A.__webglFramebuffer,D)}else if(J){A.__webglDepthbuffer=[];for(let Mt=0;Mt<6;Mt++)i.bindFramebuffer(o.FRAMEBUFFER,A.__webglFramebuffer[Mt]),A.__webglDepthbuffer[Mt]=o.createRenderbuffer(),Xt(A.__webglDepthbuffer[Mt],D,!1)}else i.bindFramebuffer(o.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer=o.createRenderbuffer(),Xt(A.__webglDepthbuffer,D,!1);i.bindFramebuffer(o.FRAMEBUFFER,null)}function Gt(D,A,J){const Mt=s.get(D);A!==void 0&&Tt(Mt.__webglFramebuffer,D,D.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),J!==void 0&&vt(D)}function Y(D){const A=D.texture,J=s.get(D),Mt=s.get(A);D.addEventListener("dispose",lt),D.isWebGLMultipleRenderTargets!==!0&&(Mt.__webglTexture===void 0&&(Mt.__webglTexture=o.createTexture()),Mt.__version=A.version,d.memory.textures++);const St=D.isWebGLCubeRenderTarget===!0,_t=D.isWebGLMultipleRenderTargets===!0,It=x(D)||h;if(St){J.__webglFramebuffer=[];for(let wt=0;wt<6;wt++)if(h&&A.mipmaps&&A.mipmaps.length>0){J.__webglFramebuffer[wt]=[];for(let Ft=0;Ft<A.mipmaps.length;Ft++)J.__webglFramebuffer[wt][Ft]=o.createFramebuffer()}else J.__webglFramebuffer[wt]=o.createFramebuffer()}else{if(h&&A.mipmaps&&A.mipmaps.length>0){J.__webglFramebuffer=[];for(let wt=0;wt<A.mipmaps.length;wt++)J.__webglFramebuffer[wt]=o.createFramebuffer()}else J.__webglFramebuffer=o.createFramebuffer();if(_t)if(l.drawBuffers){const wt=D.texture;for(let Ft=0,Yt=wt.length;Ft<Yt;Ft++){const ae=s.get(wt[Ft]);ae.__webglTexture===void 0&&(ae.__webglTexture=o.createTexture(),d.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(h&&D.samples>0&&zt(D)===!1){const wt=_t?A:[A];J.__webglMultisampledFramebuffer=o.createFramebuffer(),J.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,J.__webglMultisampledFramebuffer);for(let Ft=0;Ft<wt.length;Ft++){const Yt=wt[Ft];J.__webglColorRenderbuffer[Ft]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,J.__webglColorRenderbuffer[Ft]);const ae=u.convert(Yt.format,Yt.colorSpace),yt=u.convert(Yt.type),xe=O(Yt.internalFormat,ae,yt,Yt.colorSpace,D.isXRRenderTarget===!0),re=Pt(D);o.renderbufferStorageMultisample(o.RENDERBUFFER,re,xe,D.width,D.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Ft,o.RENDERBUFFER,J.__webglColorRenderbuffer[Ft])}o.bindRenderbuffer(o.RENDERBUFFER,null),D.depthBuffer&&(J.__webglDepthRenderbuffer=o.createRenderbuffer(),Xt(J.__webglDepthRenderbuffer,D,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(St){i.bindTexture(o.TEXTURE_CUBE_MAP,Mt.__webglTexture),G(o.TEXTURE_CUBE_MAP,A,It);for(let wt=0;wt<6;wt++)if(h&&A.mipmaps&&A.mipmaps.length>0)for(let Ft=0;Ft<A.mipmaps.length;Ft++)Tt(J.__webglFramebuffer[wt][Ft],D,A,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+wt,Ft);else Tt(J.__webglFramebuffer[wt],D,A,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+wt,0);L(A,It)&&R(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(_t){const wt=D.texture;for(let Ft=0,Yt=wt.length;Ft<Yt;Ft++){const ae=wt[Ft],yt=s.get(ae);i.bindTexture(o.TEXTURE_2D,yt.__webglTexture),G(o.TEXTURE_2D,ae,It),Tt(J.__webglFramebuffer,D,ae,o.COLOR_ATTACHMENT0+Ft,o.TEXTURE_2D,0),L(ae,It)&&R(o.TEXTURE_2D)}i.unbindTexture()}else{let wt=o.TEXTURE_2D;if((D.isWebGL3DRenderTarget||D.isWebGLArrayRenderTarget)&&(h?wt=D.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),i.bindTexture(wt,Mt.__webglTexture),G(wt,A,It),h&&A.mipmaps&&A.mipmaps.length>0)for(let Ft=0;Ft<A.mipmaps.length;Ft++)Tt(J.__webglFramebuffer[Ft],D,A,o.COLOR_ATTACHMENT0,wt,Ft);else Tt(J.__webglFramebuffer,D,A,o.COLOR_ATTACHMENT0,wt,0);L(A,It)&&R(wt),i.unbindTexture()}D.depthBuffer&&vt(D)}function fe(D){const A=x(D)||h,J=D.isWebGLMultipleRenderTargets===!0?D.texture:[D.texture];for(let Mt=0,St=J.length;Mt<St;Mt++){const _t=J[Mt];if(L(_t,A)){const It=D.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:o.TEXTURE_2D,wt=s.get(_t).__webglTexture;i.bindTexture(It,wt),R(It),i.unbindTexture()}}}function Lt(D){if(h&&D.samples>0&&zt(D)===!1){const A=D.isWebGLMultipleRenderTargets?D.texture:[D.texture],J=D.width,Mt=D.height;let St=o.COLOR_BUFFER_BIT;const _t=[],It=D.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,wt=s.get(D),Ft=D.isWebGLMultipleRenderTargets===!0;if(Ft)for(let Yt=0;Yt<A.length;Yt++)i.bindFramebuffer(o.FRAMEBUFFER,wt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,wt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,wt.__webglMultisampledFramebuffer),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,wt.__webglFramebuffer);for(let Yt=0;Yt<A.length;Yt++){_t.push(o.COLOR_ATTACHMENT0+Yt),D.depthBuffer&&_t.push(It);const ae=wt.__ignoreDepthValues!==void 0?wt.__ignoreDepthValues:!1;if(ae===!1&&(D.depthBuffer&&(St|=o.DEPTH_BUFFER_BIT),D.stencilBuffer&&(St|=o.STENCIL_BUFFER_BIT)),Ft&&o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,wt.__webglColorRenderbuffer[Yt]),ae===!0&&(o.invalidateFramebuffer(o.READ_FRAMEBUFFER,[It]),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[It])),Ft){const yt=s.get(A[Yt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,yt,0)}o.blitFramebuffer(0,0,J,Mt,0,0,J,Mt,St,o.NEAREST),p&&o.invalidateFramebuffer(o.READ_FRAMEBUFFER,_t)}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),Ft)for(let Yt=0;Yt<A.length;Yt++){i.bindFramebuffer(o.FRAMEBUFFER,wt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.RENDERBUFFER,wt.__webglColorRenderbuffer[Yt]);const ae=s.get(A[Yt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,wt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Yt,o.TEXTURE_2D,ae,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,wt.__webglMultisampledFramebuffer)}}function Pt(D){return Math.min(l.maxSamples,D.samples)}function zt(D){const A=s.get(D);return h&&D.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function Te(D){const A=d.render.frame;_.get(D)!==A&&(_.set(D,A),D.update())}function Jt(D,A){const J=D.colorSpace,Mt=D.format,St=D.type;return D.isCompressedTexture===!0||D.isVideoTexture===!0||D.format===Ah||J!==na&&J!==fi&&(Be.getTransfer(J)===ke?h===!1?e.has("EXT_sRGB")===!0&&Mt===xi?(D.format=Ah,D.minFilter=ci,D.generateMipmaps=!1):A=g0.sRGBToLinear(A):(Mt!==xi||St!==Ha)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",J)),A}this.allocateTextureUnit=k,this.resetTextureUnits=Et,this.setTexture2D=P,this.setTexture2DArray=q,this.setTexture3D=Q,this.setTextureCube=ct,this.rebindTextures=Gt,this.setupRenderTarget=Y,this.updateRenderTargetMipmap=fe,this.updateMultisampleRenderTarget=Lt,this.setupDepthRenderbuffer=vt,this.setupFrameBufferTexture=Tt,this.useMultisampledRTT=zt}function ib(o,e,i){const s=i.isWebGL2;function l(u,d=fi){let h;const m=Be.getTransfer(d);if(u===Ha)return o.UNSIGNED_BYTE;if(u===o0)return o.UNSIGNED_SHORT_4_4_4_4;if(u===l0)return o.UNSIGNED_SHORT_5_5_5_1;if(u===By)return o.BYTE;if(u===Iy)return o.SHORT;if(u===Lh)return o.UNSIGNED_SHORT;if(u===s0)return o.INT;if(u===Pa)return o.UNSIGNED_INT;if(u===Ba)return o.FLOAT;if(u===wo)return s?o.HALF_FLOAT:(h=e.get("OES_texture_half_float"),h!==null?h.HALF_FLOAT_OES:null);if(u===Fy)return o.ALPHA;if(u===xi)return o.RGBA;if(u===Hy)return o.LUMINANCE;if(u===Gy)return o.LUMINANCE_ALPHA;if(u===pr)return o.DEPTH_COMPONENT;if(u===ys)return o.DEPTH_STENCIL;if(u===Ah)return h=e.get("EXT_sRGB"),h!==null?h.SRGB_ALPHA_EXT:null;if(u===Vy)return o.RED;if(u===c0)return o.RED_INTEGER;if(u===ky)return o.RG;if(u===u0)return o.RG_INTEGER;if(u===f0)return o.RGBA_INTEGER;if(u===Gf||u===Vf||u===kf||u===Xf)if(m===ke)if(h=e.get("WEBGL_compressed_texture_s3tc_srgb"),h!==null){if(u===Gf)return h.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(u===Vf)return h.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(u===kf)return h.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(u===Xf)return h.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(h=e.get("WEBGL_compressed_texture_s3tc"),h!==null){if(u===Gf)return h.COMPRESSED_RGB_S3TC_DXT1_EXT;if(u===Vf)return h.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(u===kf)return h.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(u===Xf)return h.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(u===Pg||u===Bg||u===Ig||u===Fg)if(h=e.get("WEBGL_compressed_texture_pvrtc"),h!==null){if(u===Pg)return h.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(u===Bg)return h.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(u===Ig)return h.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(u===Fg)return h.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(u===h0)return h=e.get("WEBGL_compressed_texture_etc1"),h!==null?h.COMPRESSED_RGB_ETC1_WEBGL:null;if(u===Hg||u===Gg)if(h=e.get("WEBGL_compressed_texture_etc"),h!==null){if(u===Hg)return m===ke?h.COMPRESSED_SRGB8_ETC2:h.COMPRESSED_RGB8_ETC2;if(u===Gg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:h.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(u===Vg||u===kg||u===Xg||u===Wg||u===qg||u===Yg||u===jg||u===Zg||u===Kg||u===Qg||u===Jg||u===$g||u===t_||u===e_)if(h=e.get("WEBGL_compressed_texture_astc"),h!==null){if(u===Vg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:h.COMPRESSED_RGBA_ASTC_4x4_KHR;if(u===kg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:h.COMPRESSED_RGBA_ASTC_5x4_KHR;if(u===Xg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:h.COMPRESSED_RGBA_ASTC_5x5_KHR;if(u===Wg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:h.COMPRESSED_RGBA_ASTC_6x5_KHR;if(u===qg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:h.COMPRESSED_RGBA_ASTC_6x6_KHR;if(u===Yg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:h.COMPRESSED_RGBA_ASTC_8x5_KHR;if(u===jg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:h.COMPRESSED_RGBA_ASTC_8x6_KHR;if(u===Zg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:h.COMPRESSED_RGBA_ASTC_8x8_KHR;if(u===Kg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:h.COMPRESSED_RGBA_ASTC_10x5_KHR;if(u===Qg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:h.COMPRESSED_RGBA_ASTC_10x6_KHR;if(u===Jg)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:h.COMPRESSED_RGBA_ASTC_10x8_KHR;if(u===$g)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:h.COMPRESSED_RGBA_ASTC_10x10_KHR;if(u===t_)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:h.COMPRESSED_RGBA_ASTC_12x10_KHR;if(u===e_)return m===ke?h.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:h.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(u===Wf||u===n_||u===i_)if(h=e.get("EXT_texture_compression_bptc"),h!==null){if(u===Wf)return m===ke?h.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:h.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(u===n_)return h.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(u===i_)return h.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(u===Xy||u===a_||u===r_||u===s_)if(h=e.get("EXT_texture_compression_rgtc"),h!==null){if(u===Wf)return h.COMPRESSED_RED_RGTC1_EXT;if(u===a_)return h.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(u===r_)return h.COMPRESSED_RED_GREEN_RGTC2_EXT;if(u===s_)return h.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return u===dr?s?o.UNSIGNED_INT_24_8:(h=e.get("WEBGL_depth_texture"),h!==null?h.UNSIGNED_INT_24_8_WEBGL:null):o[u]!==void 0?o[u]:null}return{convert:l}}class ab extends ui{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class hc extends Hn{constructor(){super(),this.isGroup=!0,this.type="Group"}}const rb={type:"move"};class gh{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new hc,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new hc,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new nt,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new nt),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new hc,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new nt,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new nt),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const i=this._hand;if(i)for(const s of e.hand.values())this._getHandJoint(i,s)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,i,s){let l=null,u=null,d=null;const h=this._targetRay,m=this._grip,p=this._hand;if(e&&i.session.visibilityState!=="visible-blurred"){if(p&&e.hand){d=!0;for(const T of e.hand.values()){const x=i.getJointPose(T,s),v=this._getHandJoint(p,T);x!==null&&(v.matrix.fromArray(x.transform.matrix),v.matrix.decompose(v.position,v.rotation,v.scale),v.matrixWorldNeedsUpdate=!0,v.jointRadius=x.radius),v.visible=x!==null}const _=p.joints["index-finger-tip"],S=p.joints["thumb-tip"],y=_.position.distanceTo(S.position),M=.02,b=.005;p.inputState.pinching&&y>M+b?(p.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!p.inputState.pinching&&y<=M-b&&(p.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else m!==null&&e.gripSpace&&(u=i.getPose(e.gripSpace,s),u!==null&&(m.matrix.fromArray(u.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,u.linearVelocity?(m.hasLinearVelocity=!0,m.linearVelocity.copy(u.linearVelocity)):m.hasLinearVelocity=!1,u.angularVelocity?(m.hasAngularVelocity=!0,m.angularVelocity.copy(u.angularVelocity)):m.hasAngularVelocity=!1));h!==null&&(l=i.getPose(e.targetRaySpace,s),l===null&&u!==null&&(l=u),l!==null&&(h.matrix.fromArray(l.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,l.linearVelocity?(h.hasLinearVelocity=!0,h.linearVelocity.copy(l.linearVelocity)):h.hasLinearVelocity=!1,l.angularVelocity?(h.hasAngularVelocity=!0,h.angularVelocity.copy(l.angularVelocity)):h.hasAngularVelocity=!1,this.dispatchEvent(rb)))}return h!==null&&(h.visible=l!==null),m!==null&&(m.visible=u!==null),p!==null&&(p.visible=d!==null),this}_getHandJoint(e,i){if(e.joints[i.jointName]===void 0){const s=new hc;s.matrixAutoUpdate=!1,s.visible=!1,e.joints[i.jointName]=s,e.add(s)}return e.joints[i.jointName]}}class sb extends Ms{constructor(e,i){super();const s=this;let l=null,u=1,d=null,h="local-floor",m=1,p=null,_=null,S=null,y=null,M=null,b=null;const T=i.getContextAttributes();let x=null,v=null;const L=[],R=[],O=new be;let X=null;const I=new ui;I.layers.enable(1),I.viewport=new yn;const z=new ui;z.layers.enable(2),z.viewport=new yn;const lt=[I,z],C=new ab;C.layers.enable(1),C.layers.enable(2);let N=null,ot=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(G){let Z=L[G];return Z===void 0&&(Z=new gh,L[G]=Z),Z.getTargetRaySpace()},this.getControllerGrip=function(G){let Z=L[G];return Z===void 0&&(Z=new gh,L[G]=Z),Z.getGripSpace()},this.getHand=function(G){let Z=L[G];return Z===void 0&&(Z=new gh,L[G]=Z),Z.getHandSpace()};function ft(G){const Z=R.indexOf(G.inputSource);if(Z===-1)return;const pt=L[Z];pt!==void 0&&(pt.update(G.inputSource,G.frame,p||d),pt.dispatchEvent({type:G.type,data:G.inputSource}))}function Et(){l.removeEventListener("select",ft),l.removeEventListener("selectstart",ft),l.removeEventListener("selectend",ft),l.removeEventListener("squeeze",ft),l.removeEventListener("squeezestart",ft),l.removeEventListener("squeezeend",ft),l.removeEventListener("end",Et),l.removeEventListener("inputsourceschange",k);for(let G=0;G<L.length;G++){const Z=R[G];Z!==null&&(R[G]=null,L[G].disconnect(Z))}N=null,ot=null,e.setRenderTarget(x),M=null,y=null,S=null,l=null,v=null,V.stop(),s.isPresenting=!1,e.setPixelRatio(X),e.setSize(O.width,O.height,!1),s.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(G){u=G,s.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(G){h=G,s.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||d},this.setReferenceSpace=function(G){p=G},this.getBaseLayer=function(){return y!==null?y:M},this.getBinding=function(){return S},this.getFrame=function(){return b},this.getSession=function(){return l},this.setSession=async function(G){if(l=G,l!==null){if(x=e.getRenderTarget(),l.addEventListener("select",ft),l.addEventListener("selectstart",ft),l.addEventListener("selectend",ft),l.addEventListener("squeeze",ft),l.addEventListener("squeezestart",ft),l.addEventListener("squeezeend",ft),l.addEventListener("end",Et),l.addEventListener("inputsourceschange",k),T.xrCompatible!==!0&&await i.makeXRCompatible(),X=e.getPixelRatio(),e.getSize(O),l.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const Z={antialias:l.renderState.layers===void 0?T.antialias:!0,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:u};M=new XRWebGLLayer(l,i,Z),l.updateRenderState({baseLayer:M}),e.setPixelRatio(1),e.setSize(M.framebufferWidth,M.framebufferHeight,!1),v=new gr(M.framebufferWidth,M.framebufferHeight,{format:xi,type:Ha,colorSpace:e.outputColorSpace,stencilBuffer:T.stencil})}else{let Z=null,pt=null,xt=null;T.depth&&(xt=T.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Z=T.stencil?ys:pr,pt=T.stencil?dr:Pa);const Tt={colorFormat:i.RGBA8,depthFormat:xt,scaleFactor:u};S=new XRWebGLBinding(l,i),y=S.createProjectionLayer(Tt),l.updateRenderState({layers:[y]}),e.setPixelRatio(1),e.setSize(y.textureWidth,y.textureHeight,!1),v=new gr(y.textureWidth,y.textureHeight,{format:xi,type:Ha,depthTexture:new w0(y.textureWidth,y.textureHeight,pt,void 0,void 0,void 0,void 0,void 0,void 0,Z),stencilBuffer:T.stencil,colorSpace:e.outputColorSpace,samples:T.antialias?4:0});const Xt=e.properties.get(v);Xt.__ignoreDepthValues=y.ignoreDepthValues}v.isXRRenderTarget=!0,this.setFoveation(m),p=null,d=await l.requestReferenceSpace(h),V.setContext(l),V.start(),s.isPresenting=!0,s.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode};function k(G){for(let Z=0;Z<G.removed.length;Z++){const pt=G.removed[Z],xt=R.indexOf(pt);xt>=0&&(R[xt]=null,L[xt].disconnect(pt))}for(let Z=0;Z<G.added.length;Z++){const pt=G.added[Z];let xt=R.indexOf(pt);if(xt===-1){for(let Xt=0;Xt<L.length;Xt++)if(Xt>=R.length){R.push(pt),xt=Xt;break}else if(R[Xt]===null){R[Xt]=pt,xt=Xt;break}if(xt===-1)break}const Tt=L[xt];Tt&&Tt.connect(pt)}}const et=new nt,P=new nt;function q(G,Z,pt){et.setFromMatrixPosition(Z.matrixWorld),P.setFromMatrixPosition(pt.matrixWorld);const xt=et.distanceTo(P),Tt=Z.projectionMatrix.elements,Xt=pt.projectionMatrix.elements,mt=Tt[14]/(Tt[10]-1),vt=Tt[14]/(Tt[10]+1),Gt=(Tt[9]+1)/Tt[5],Y=(Tt[9]-1)/Tt[5],fe=(Tt[8]-1)/Tt[0],Lt=(Xt[8]+1)/Xt[0],Pt=mt*fe,zt=mt*Lt,Te=xt/(-fe+Lt),Jt=Te*-fe;Z.matrixWorld.decompose(G.position,G.quaternion,G.scale),G.translateX(Jt),G.translateZ(Te),G.matrixWorld.compose(G.position,G.quaternion,G.scale),G.matrixWorldInverse.copy(G.matrixWorld).invert();const D=mt+Te,A=vt+Te,J=Pt-Jt,Mt=zt+(xt-Jt),St=Gt*vt/A*D,_t=Y*vt/A*D;G.projectionMatrix.makePerspective(J,Mt,St,_t,D,A),G.projectionMatrixInverse.copy(G.projectionMatrix).invert()}function Q(G,Z){Z===null?G.matrixWorld.copy(G.matrix):G.matrixWorld.multiplyMatrices(Z.matrixWorld,G.matrix),G.matrixWorldInverse.copy(G.matrixWorld).invert()}this.updateCamera=function(G){if(l===null)return;C.near=z.near=I.near=G.near,C.far=z.far=I.far=G.far,(N!==C.near||ot!==C.far)&&(l.updateRenderState({depthNear:C.near,depthFar:C.far}),N=C.near,ot=C.far);const Z=G.parent,pt=C.cameras;Q(C,Z);for(let xt=0;xt<pt.length;xt++)Q(pt[xt],Z);pt.length===2?q(C,I,z):C.projectionMatrix.copy(I.projectionMatrix),ct(G,C,Z)};function ct(G,Z,pt){pt===null?G.matrix.copy(Z.matrixWorld):(G.matrix.copy(pt.matrixWorld),G.matrix.invert(),G.matrix.multiply(Z.matrixWorld)),G.matrix.decompose(G.position,G.quaternion,G.scale),G.updateMatrixWorld(!0),G.projectionMatrix.copy(Z.projectionMatrix),G.projectionMatrixInverse.copy(Z.projectionMatrixInverse),G.isPerspectiveCamera&&(G.fov=bh*2*Math.atan(1/G.projectionMatrix.elements[5]),G.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(y===null&&M===null))return m},this.setFoveation=function(G){m=G,y!==null&&(y.fixedFoveation=G),M!==null&&M.fixedFoveation!==void 0&&(M.fixedFoveation=G)};let ut=null;function U(G,Z){if(_=Z.getViewerPose(p||d),b=Z,_!==null){const pt=_.views;M!==null&&(e.setRenderTargetFramebuffer(v,M.framebuffer),e.setRenderTarget(v));let xt=!1;pt.length!==C.cameras.length&&(C.cameras.length=0,xt=!0);for(let Tt=0;Tt<pt.length;Tt++){const Xt=pt[Tt];let mt=null;if(M!==null)mt=M.getViewport(Xt);else{const Gt=S.getViewSubImage(y,Xt);mt=Gt.viewport,Tt===0&&(e.setRenderTargetTextures(v,Gt.colorTexture,y.ignoreDepthValues?void 0:Gt.depthStencilTexture),e.setRenderTarget(v))}let vt=lt[Tt];vt===void 0&&(vt=new ui,vt.layers.enable(Tt),vt.viewport=new yn,lt[Tt]=vt),vt.matrix.fromArray(Xt.transform.matrix),vt.matrix.decompose(vt.position,vt.quaternion,vt.scale),vt.projectionMatrix.fromArray(Xt.projectionMatrix),vt.projectionMatrixInverse.copy(vt.projectionMatrix).invert(),vt.viewport.set(mt.x,mt.y,mt.width,mt.height),Tt===0&&(C.matrix.copy(vt.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),xt===!0&&C.cameras.push(vt)}}for(let pt=0;pt<L.length;pt++){const xt=R[pt],Tt=L[pt];xt!==null&&Tt!==void 0&&Tt.update(xt,Z,p||d)}ut&&ut(G,Z),Z.detectedPlanes&&s.dispatchEvent({type:"planesdetected",data:Z}),b=null}const V=new C0;V.setAnimationLoop(U),this.setAnimationLoop=function(G){ut=G},this.dispose=function(){}}}function ob(o,e){function i(x,v){x.matrixAutoUpdate===!0&&x.updateMatrix(),v.value.copy(x.matrix)}function s(x,v){v.color.getRGB(x.fogColor.value,T0(o)),v.isFog?(x.fogNear.value=v.near,x.fogFar.value=v.far):v.isFogExp2&&(x.fogDensity.value=v.density)}function l(x,v,L,R,O){v.isMeshBasicMaterial||v.isMeshLambertMaterial?u(x,v):v.isMeshToonMaterial?(u(x,v),S(x,v)):v.isMeshPhongMaterial?(u(x,v),_(x,v)):v.isMeshStandardMaterial?(u(x,v),y(x,v),v.isMeshPhysicalMaterial&&M(x,v,O)):v.isMeshMatcapMaterial?(u(x,v),b(x,v)):v.isMeshDepthMaterial?u(x,v):v.isMeshDistanceMaterial?(u(x,v),T(x,v)):v.isMeshNormalMaterial?u(x,v):v.isLineBasicMaterial?(d(x,v),v.isLineDashedMaterial&&h(x,v)):v.isPointsMaterial?m(x,v,L,R):v.isSpriteMaterial?p(x,v):v.isShadowMaterial?(x.color.value.copy(v.color),x.opacity.value=v.opacity):v.isShaderMaterial&&(v.uniformsNeedUpdate=!1)}function u(x,v){x.opacity.value=v.opacity,v.color&&x.diffuse.value.copy(v.color),v.emissive&&x.emissive.value.copy(v.emissive).multiplyScalar(v.emissiveIntensity),v.map&&(x.map.value=v.map,i(v.map,x.mapTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,i(v.alphaMap,x.alphaMapTransform)),v.bumpMap&&(x.bumpMap.value=v.bumpMap,i(v.bumpMap,x.bumpMapTransform),x.bumpScale.value=v.bumpScale,v.side===Fn&&(x.bumpScale.value*=-1)),v.normalMap&&(x.normalMap.value=v.normalMap,i(v.normalMap,x.normalMapTransform),x.normalScale.value.copy(v.normalScale),v.side===Fn&&x.normalScale.value.negate()),v.displacementMap&&(x.displacementMap.value=v.displacementMap,i(v.displacementMap,x.displacementMapTransform),x.displacementScale.value=v.displacementScale,x.displacementBias.value=v.displacementBias),v.emissiveMap&&(x.emissiveMap.value=v.emissiveMap,i(v.emissiveMap,x.emissiveMapTransform)),v.specularMap&&(x.specularMap.value=v.specularMap,i(v.specularMap,x.specularMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest);const L=e.get(v).envMap;if(L&&(x.envMap.value=L,x.flipEnvMap.value=L.isCubeTexture&&L.isRenderTargetTexture===!1?-1:1,x.reflectivity.value=v.reflectivity,x.ior.value=v.ior,x.refractionRatio.value=v.refractionRatio),v.lightMap){x.lightMap.value=v.lightMap;const R=o._useLegacyLights===!0?Math.PI:1;x.lightMapIntensity.value=v.lightMapIntensity*R,i(v.lightMap,x.lightMapTransform)}v.aoMap&&(x.aoMap.value=v.aoMap,x.aoMapIntensity.value=v.aoMapIntensity,i(v.aoMap,x.aoMapTransform))}function d(x,v){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,v.map&&(x.map.value=v.map,i(v.map,x.mapTransform))}function h(x,v){x.dashSize.value=v.dashSize,x.totalSize.value=v.dashSize+v.gapSize,x.scale.value=v.scale}function m(x,v,L,R){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,x.size.value=v.size*L,x.scale.value=R*.5,v.map&&(x.map.value=v.map,i(v.map,x.uvTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,i(v.alphaMap,x.alphaMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest)}function p(x,v){x.diffuse.value.copy(v.color),x.opacity.value=v.opacity,x.rotation.value=v.rotation,v.map&&(x.map.value=v.map,i(v.map,x.mapTransform)),v.alphaMap&&(x.alphaMap.value=v.alphaMap,i(v.alphaMap,x.alphaMapTransform)),v.alphaTest>0&&(x.alphaTest.value=v.alphaTest)}function _(x,v){x.specular.value.copy(v.specular),x.shininess.value=Math.max(v.shininess,1e-4)}function S(x,v){v.gradientMap&&(x.gradientMap.value=v.gradientMap)}function y(x,v){x.metalness.value=v.metalness,v.metalnessMap&&(x.metalnessMap.value=v.metalnessMap,i(v.metalnessMap,x.metalnessMapTransform)),x.roughness.value=v.roughness,v.roughnessMap&&(x.roughnessMap.value=v.roughnessMap,i(v.roughnessMap,x.roughnessMapTransform)),e.get(v).envMap&&(x.envMapIntensity.value=v.envMapIntensity)}function M(x,v,L){x.ior.value=v.ior,v.sheen>0&&(x.sheenColor.value.copy(v.sheenColor).multiplyScalar(v.sheen),x.sheenRoughness.value=v.sheenRoughness,v.sheenColorMap&&(x.sheenColorMap.value=v.sheenColorMap,i(v.sheenColorMap,x.sheenColorMapTransform)),v.sheenRoughnessMap&&(x.sheenRoughnessMap.value=v.sheenRoughnessMap,i(v.sheenRoughnessMap,x.sheenRoughnessMapTransform))),v.clearcoat>0&&(x.clearcoat.value=v.clearcoat,x.clearcoatRoughness.value=v.clearcoatRoughness,v.clearcoatMap&&(x.clearcoatMap.value=v.clearcoatMap,i(v.clearcoatMap,x.clearcoatMapTransform)),v.clearcoatRoughnessMap&&(x.clearcoatRoughnessMap.value=v.clearcoatRoughnessMap,i(v.clearcoatRoughnessMap,x.clearcoatRoughnessMapTransform)),v.clearcoatNormalMap&&(x.clearcoatNormalMap.value=v.clearcoatNormalMap,i(v.clearcoatNormalMap,x.clearcoatNormalMapTransform),x.clearcoatNormalScale.value.copy(v.clearcoatNormalScale),v.side===Fn&&x.clearcoatNormalScale.value.negate())),v.iridescence>0&&(x.iridescence.value=v.iridescence,x.iridescenceIOR.value=v.iridescenceIOR,x.iridescenceThicknessMinimum.value=v.iridescenceThicknessRange[0],x.iridescenceThicknessMaximum.value=v.iridescenceThicknessRange[1],v.iridescenceMap&&(x.iridescenceMap.value=v.iridescenceMap,i(v.iridescenceMap,x.iridescenceMapTransform)),v.iridescenceThicknessMap&&(x.iridescenceThicknessMap.value=v.iridescenceThicknessMap,i(v.iridescenceThicknessMap,x.iridescenceThicknessMapTransform))),v.transmission>0&&(x.transmission.value=v.transmission,x.transmissionSamplerMap.value=L.texture,x.transmissionSamplerSize.value.set(L.width,L.height),v.transmissionMap&&(x.transmissionMap.value=v.transmissionMap,i(v.transmissionMap,x.transmissionMapTransform)),x.thickness.value=v.thickness,v.thicknessMap&&(x.thicknessMap.value=v.thicknessMap,i(v.thicknessMap,x.thicknessMapTransform)),x.attenuationDistance.value=v.attenuationDistance,x.attenuationColor.value.copy(v.attenuationColor)),v.anisotropy>0&&(x.anisotropyVector.value.set(v.anisotropy*Math.cos(v.anisotropyRotation),v.anisotropy*Math.sin(v.anisotropyRotation)),v.anisotropyMap&&(x.anisotropyMap.value=v.anisotropyMap,i(v.anisotropyMap,x.anisotropyMapTransform))),x.specularIntensity.value=v.specularIntensity,x.specularColor.value.copy(v.specularColor),v.specularColorMap&&(x.specularColorMap.value=v.specularColorMap,i(v.specularColorMap,x.specularColorMapTransform)),v.specularIntensityMap&&(x.specularIntensityMap.value=v.specularIntensityMap,i(v.specularIntensityMap,x.specularIntensityMapTransform))}function b(x,v){v.matcap&&(x.matcap.value=v.matcap)}function T(x,v){const L=e.get(v).light;x.referencePosition.value.setFromMatrixPosition(L.matrixWorld),x.nearDistance.value=L.shadow.camera.near,x.farDistance.value=L.shadow.camera.far}return{refreshFogUniforms:s,refreshMaterialUniforms:l}}function lb(o,e,i,s){let l={},u={},d=[];const h=i.isWebGL2?o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS):0;function m(L,R){const O=R.program;s.uniformBlockBinding(L,O)}function p(L,R){let O=l[L.id];O===void 0&&(b(L),O=_(L),l[L.id]=O,L.addEventListener("dispose",x));const X=R.program;s.updateUBOMapping(L,X);const I=e.render.frame;u[L.id]!==I&&(y(L),u[L.id]=I)}function _(L){const R=S();L.__bindingPointIndex=R;const O=o.createBuffer(),X=L.__size,I=L.usage;return o.bindBuffer(o.UNIFORM_BUFFER,O),o.bufferData(o.UNIFORM_BUFFER,X,I),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,R,O),O}function S(){for(let L=0;L<h;L++)if(d.indexOf(L)===-1)return d.push(L),L;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function y(L){const R=l[L.id],O=L.uniforms,X=L.__cache;o.bindBuffer(o.UNIFORM_BUFFER,R);for(let I=0,z=O.length;I<z;I++){const lt=Array.isArray(O[I])?O[I]:[O[I]];for(let C=0,N=lt.length;C<N;C++){const ot=lt[C];if(M(ot,I,C,X)===!0){const ft=ot.__offset,Et=Array.isArray(ot.value)?ot.value:[ot.value];let k=0;for(let et=0;et<Et.length;et++){const P=Et[et],q=T(P);typeof P=="number"||typeof P=="boolean"?(ot.__data[0]=P,o.bufferSubData(o.UNIFORM_BUFFER,ft+k,ot.__data)):P.isMatrix3?(ot.__data[0]=P.elements[0],ot.__data[1]=P.elements[1],ot.__data[2]=P.elements[2],ot.__data[3]=0,ot.__data[4]=P.elements[3],ot.__data[5]=P.elements[4],ot.__data[6]=P.elements[5],ot.__data[7]=0,ot.__data[8]=P.elements[6],ot.__data[9]=P.elements[7],ot.__data[10]=P.elements[8],ot.__data[11]=0):(P.toArray(ot.__data,k),k+=q.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,ft,ot.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function M(L,R,O,X){const I=L.value,z=R+"_"+O;if(X[z]===void 0)return typeof I=="number"||typeof I=="boolean"?X[z]=I:X[z]=I.clone(),!0;{const lt=X[z];if(typeof I=="number"||typeof I=="boolean"){if(lt!==I)return X[z]=I,!0}else if(lt.equals(I)===!1)return lt.copy(I),!0}return!1}function b(L){const R=L.uniforms;let O=0;const X=16;for(let z=0,lt=R.length;z<lt;z++){const C=Array.isArray(R[z])?R[z]:[R[z]];for(let N=0,ot=C.length;N<ot;N++){const ft=C[N],Et=Array.isArray(ft.value)?ft.value:[ft.value];for(let k=0,et=Et.length;k<et;k++){const P=Et[k],q=T(P),Q=O%X;Q!==0&&X-Q<q.boundary&&(O+=X-Q),ft.__data=new Float32Array(q.storage/Float32Array.BYTES_PER_ELEMENT),ft.__offset=O,O+=q.storage}}}const I=O%X;return I>0&&(O+=X-I),L.__size=O,L.__cache={},this}function T(L){const R={boundary:0,storage:0};return typeof L=="number"||typeof L=="boolean"?(R.boundary=4,R.storage=4):L.isVector2?(R.boundary=8,R.storage=8):L.isVector3||L.isColor?(R.boundary=16,R.storage=12):L.isVector4?(R.boundary=16,R.storage=16):L.isMatrix3?(R.boundary=48,R.storage=48):L.isMatrix4?(R.boundary=64,R.storage=64):L.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",L),R}function x(L){const R=L.target;R.removeEventListener("dispose",x);const O=d.indexOf(R.__bindingPointIndex);d.splice(O,1),o.deleteBuffer(l[R.id]),delete l[R.id],delete u[R.id]}function v(){for(const L in l)o.deleteBuffer(l[L]);d=[],l={},u={}}return{bind:m,update:p,dispose:v}}class z0{constructor(e={}){const{canvas:i=ix(),context:s=null,depth:l=!0,stencil:u=!0,alpha:d=!1,antialias:h=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:S=!1}=e;this.isWebGLRenderer=!0;let y;s!==null?y=s.getContextAttributes().alpha:y=d;const M=new Uint32Array(4),b=new Int32Array(4);let T=null,x=null;const v=[],L=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Sn,this._useLegacyLights=!1,this.toneMapping=Fa,this.toneMappingExposure=1;const R=this;let O=!1,X=0,I=0,z=null,lt=-1,C=null;const N=new yn,ot=new yn;let ft=null;const Et=new De(0);let k=0,et=i.width,P=i.height,q=1,Q=null,ct=null;const ut=new yn(0,0,et,P),U=new yn(0,0,et,P);let V=!1;const G=new R0;let Z=!1,pt=!1,xt=null;const Tt=new dn,Xt=new be,mt=new nt,vt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Gt(){return z===null?q:1}let Y=s;function fe(w,j){for(let at=0;at<w.length;at++){const rt=w[at],it=i.getContext(rt,j);if(it!==null)return it}return null}try{const w={alpha:!0,depth:l,stencil:u,antialias:h,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:S};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${Dh}`),i.addEventListener("webglcontextlost",At,!1),i.addEventListener("webglcontextrestored",F,!1),i.addEventListener("webglcontextcreationerror",Ut,!1),Y===null){const j=["webgl2","webgl","experimental-webgl"];if(R.isWebGL1Renderer===!0&&j.shift(),Y=fe(j,w),Y===null)throw fe(j)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&Y instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),Y.getShaderPrecisionFormat===void 0&&(Y.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let Lt,Pt,zt,Te,Jt,D,A,J,Mt,St,_t,It,wt,Ft,Yt,ae,yt,xe,re,Ot,bt,Dt,Bt,pe;function ye(){Lt=new vT(Y),Pt=new fT(Y,Lt,e),Lt.init(Pt),Dt=new ib(Y,Lt,Pt),zt=new eb(Y,Lt,Pt),Te=new xT(Y),Jt=new GA,D=new nb(Y,Lt,zt,Jt,Pt,Dt,Te),A=new dT(R),J=new _T(R),Mt=new Cx(Y,Pt),Bt=new cT(Y,Lt,Mt,Pt),St=new ST(Y,Mt,Te,Bt),_t=new AT(Y,St,Mt,Te),re=new TT(Y,Pt,D),ae=new hT(Jt),It=new HA(R,A,J,Lt,Pt,Bt,ae),wt=new ob(R,Jt),Ft=new kA,Yt=new ZA(Lt,Pt),xe=new lT(R,A,J,zt,_t,y,m),yt=new tb(R,_t,Pt),pe=new lb(Y,Te,Pt,zt),Ot=new uT(Y,Lt,Te,Pt),bt=new yT(Y,Lt,Te,Pt),Te.programs=It.programs,R.capabilities=Pt,R.extensions=Lt,R.properties=Jt,R.renderLists=Ft,R.shadowMap=yt,R.state=zt,R.info=Te}ye();const se=new sb(R,Y);this.xr=se,this.getContext=function(){return Y},this.getContextAttributes=function(){return Y.getContextAttributes()},this.forceContextLoss=function(){const w=Lt.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=Lt.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return q},this.setPixelRatio=function(w){w!==void 0&&(q=w,this.setSize(et,P,!1))},this.getSize=function(w){return w.set(et,P)},this.setSize=function(w,j,at=!0){if(se.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}et=w,P=j,i.width=Math.floor(w*q),i.height=Math.floor(j*q),at===!0&&(i.style.width=w+"px",i.style.height=j+"px"),this.setViewport(0,0,w,j)},this.getDrawingBufferSize=function(w){return w.set(et*q,P*q).floor()},this.setDrawingBufferSize=function(w,j,at){et=w,P=j,q=at,i.width=Math.floor(w*at),i.height=Math.floor(j*at),this.setViewport(0,0,w,j)},this.getCurrentViewport=function(w){return w.copy(N)},this.getViewport=function(w){return w.copy(ut)},this.setViewport=function(w,j,at,rt){w.isVector4?ut.set(w.x,w.y,w.z,w.w):ut.set(w,j,at,rt),zt.viewport(N.copy(ut).multiplyScalar(q).floor())},this.getScissor=function(w){return w.copy(U)},this.setScissor=function(w,j,at,rt){w.isVector4?U.set(w.x,w.y,w.z,w.w):U.set(w,j,at,rt),zt.scissor(ot.copy(U).multiplyScalar(q).floor())},this.getScissorTest=function(){return V},this.setScissorTest=function(w){zt.setScissorTest(V=w)},this.setOpaqueSort=function(w){Q=w},this.setTransparentSort=function(w){ct=w},this.getClearColor=function(w){return w.copy(xe.getClearColor())},this.setClearColor=function(){xe.setClearColor.apply(xe,arguments)},this.getClearAlpha=function(){return xe.getClearAlpha()},this.setClearAlpha=function(){xe.setClearAlpha.apply(xe,arguments)},this.clear=function(w=!0,j=!0,at=!0){let rt=0;if(w){let it=!1;if(z!==null){const Nt=z.texture.format;it=Nt===f0||Nt===u0||Nt===c0}if(it){const Nt=z.texture.type,Vt=Nt===Ha||Nt===Pa||Nt===Lh||Nt===dr||Nt===o0||Nt===l0,Kt=xe.getClearColor(),Qt=xe.getClearAlpha(),Wt=Kt.r,ee=Kt.g,ne=Kt.b;Vt?(M[0]=Wt,M[1]=ee,M[2]=ne,M[3]=Qt,Y.clearBufferuiv(Y.COLOR,0,M)):(b[0]=Wt,b[1]=ee,b[2]=ne,b[3]=Qt,Y.clearBufferiv(Y.COLOR,0,b))}else rt|=Y.COLOR_BUFFER_BIT}j&&(rt|=Y.DEPTH_BUFFER_BIT),at&&(rt|=Y.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),Y.clear(rt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",At,!1),i.removeEventListener("webglcontextrestored",F,!1),i.removeEventListener("webglcontextcreationerror",Ut,!1),Ft.dispose(),Yt.dispose(),Jt.dispose(),A.dispose(),J.dispose(),_t.dispose(),Bt.dispose(),pe.dispose(),It.dispose(),se.dispose(),se.removeEventListener("sessionstart",je),se.removeEventListener("sessionend",Ne),xt&&(xt.dispose(),xt=null),un.stop()};function At(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),O=!0}function F(){console.log("THREE.WebGLRenderer: Context Restored."),O=!1;const w=Te.autoReset,j=yt.enabled,at=yt.autoUpdate,rt=yt.needsUpdate,it=yt.type;ye(),Te.autoReset=w,yt.enabled=j,yt.autoUpdate=at,yt.needsUpdate=rt,yt.type=it}function Ut(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function Rt(w){const j=w.target;j.removeEventListener("dispose",Rt),$t(j)}function $t(w){jt(w),Jt.remove(w)}function jt(w){const j=Jt.get(w).programs;j!==void 0&&(j.forEach(function(at){It.releaseProgram(at)}),w.isShaderMaterial&&It.releaseShaderCache(w))}this.renderBufferDirect=function(w,j,at,rt,it,Nt){j===null&&(j=vt);const Vt=it.isMesh&&it.matrixWorld.determinant()<0,Kt=xn(w,j,at,rt,it);zt.setMaterial(rt,Vt);let Qt=at.index,Wt=1;if(rt.wireframe===!0){if(Qt=St.getWireframeAttribute(at),Qt===void 0)return;Wt=2}const ee=at.drawRange,ne=at.attributes.position;let Ce=ee.start*Wt,Je=(ee.start+ee.count)*Wt;Nt!==null&&(Ce=Math.max(Ce,Nt.start*Wt),Je=Math.min(Je,(Nt.start+Nt.count)*Wt)),Qt!==null?(Ce=Math.max(Ce,0),Je=Math.min(Je,Qt.count)):ne!=null&&(Ce=Math.max(Ce,0),Je=Math.min(Je,ne.count));const $e=Je-Ce;if($e<0||$e===1/0)return;Bt.setup(it,rt,Kt,at,Qt);let $n,He=Ot;if(Qt!==null&&($n=Mt.get(Qt),He=bt,He.setIndex($n)),it.isMesh)rt.wireframe===!0?(zt.setLineWidth(rt.wireframeLinewidth*Gt()),He.setMode(Y.LINES)):He.setMode(Y.TRIANGLES);else if(it.isLine){let ce=rt.linewidth;ce===void 0&&(ce=1),zt.setLineWidth(ce*Gt()),it.isLineSegments?He.setMode(Y.LINES):it.isLineLoop?He.setMode(Y.LINE_LOOP):He.setMode(Y.LINE_STRIP)}else it.isPoints?He.setMode(Y.POINTS):it.isSprite&&He.setMode(Y.TRIANGLES);if(it.isBatchedMesh)He.renderMultiDraw(it._multiDrawStarts,it._multiDrawCounts,it._multiDrawCount);else if(it.isInstancedMesh)He.renderInstances(Ce,$e,it.count);else if(at.isInstancedBufferGeometry){const ce=at._maxInstanceCount!==void 0?at._maxInstanceCount:1/0,ra=Math.min(at.instanceCount,ce);He.renderInstances(Ce,$e,ra)}else He.render(Ce,$e)};function Le(w,j,at){w.transparent===!0&&w.side===ta&&w.forceSinglePass===!1?(w.side=Fn,w.needsUpdate=!0,Va(w,j,at),w.side=Ga,w.needsUpdate=!0,Va(w,j,at),w.side=ta):Va(w,j,at)}this.compile=function(w,j,at=null){at===null&&(at=w),x=Yt.get(at),x.init(),L.push(x),at.traverseVisible(function(it){it.isLight&&it.layers.test(j.layers)&&(x.pushLight(it),it.castShadow&&x.pushShadow(it))}),w!==at&&w.traverseVisible(function(it){it.isLight&&it.layers.test(j.layers)&&(x.pushLight(it),it.castShadow&&x.pushShadow(it))}),x.setupLights(R._useLegacyLights);const rt=new Set;return w.traverse(function(it){const Nt=it.material;if(Nt)if(Array.isArray(Nt))for(let Vt=0;Vt<Nt.length;Vt++){const Kt=Nt[Vt];Le(Kt,at,it),rt.add(Kt)}else Le(Nt,at,it),rt.add(Nt)}),L.pop(),x=null,rt},this.compileAsync=function(w,j,at=null){const rt=this.compile(w,j,at);return new Promise(it=>{function Nt(){if(rt.forEach(function(Vt){Jt.get(Vt).currentProgram.isReady()&&rt.delete(Vt)}),rt.size===0){it(w);return}setTimeout(Nt,10)}Lt.get("KHR_parallel_shader_compile")!==null?Nt():setTimeout(Nt,10)})};let Re=null;function We(w){Re&&Re(w)}function je(){un.stop()}function Ne(){un.start()}const un=new C0;un.setAnimationLoop(We),typeof self<"u"&&un.setContext(self),this.setAnimationLoop=function(w){Re=w,se.setAnimationLoop(w),w===null?un.stop():un.start()},se.addEventListener("sessionstart",je),se.addEventListener("sessionend",Ne),this.render=function(w,j){if(j!==void 0&&j.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(O===!0)return;w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),j.parent===null&&j.matrixWorldAutoUpdate===!0&&j.updateMatrixWorld(),se.enabled===!0&&se.isPresenting===!0&&(se.cameraAutoUpdate===!0&&se.updateCamera(j),j=se.getCamera()),w.isScene===!0&&w.onBeforeRender(R,w,j,z),x=Yt.get(w,L.length),x.init(),L.push(x),Tt.multiplyMatrices(j.projectionMatrix,j.matrixWorldInverse),G.setFromProjectionMatrix(Tt),pt=this.localClippingEnabled,Z=ae.init(this.clippingPlanes,pt),T=Ft.get(w,v.length),T.init(),v.push(T),Gn(w,j,0,R.sortObjects),T.finish(),R.sortObjects===!0&&T.sort(Q,ct),this.info.render.frame++,Z===!0&&ae.beginShadows();const at=x.state.shadowsArray;if(yt.render(at,w,j),Z===!0&&ae.endShadows(),this.info.autoReset===!0&&this.info.reset(),xe.render(T,w),x.setupLights(R._useLegacyLights),j.isArrayCamera){const rt=j.cameras;for(let it=0,Nt=rt.length;it<Nt;it++){const Vt=rt[it];Ts(T,w,Vt,Vt.viewport)}}else Ts(T,w,j);z!==null&&(D.updateMultisampleRenderTarget(z),D.updateRenderTargetMipmap(z)),w.isScene===!0&&w.onAfterRender(R,w,j),Bt.resetDefaultState(),lt=-1,C=null,L.pop(),L.length>0?x=L[L.length-1]:x=null,v.pop(),v.length>0?T=v[v.length-1]:T=null};function Gn(w,j,at,rt){if(w.visible===!1)return;if(w.layers.test(j.layers)){if(w.isGroup)at=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(j);else if(w.isLight)x.pushLight(w),w.castShadow&&x.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||G.intersectsSprite(w)){rt&&mt.setFromMatrixPosition(w.matrixWorld).applyMatrix4(Tt);const Vt=_t.update(w),Kt=w.material;Kt.visible&&T.push(w,Vt,Kt,at,mt.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||G.intersectsObject(w))){const Vt=_t.update(w),Kt=w.material;if(rt&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),mt.copy(w.boundingSphere.center)):(Vt.boundingSphere===null&&Vt.computeBoundingSphere(),mt.copy(Vt.boundingSphere.center)),mt.applyMatrix4(w.matrixWorld).applyMatrix4(Tt)),Array.isArray(Kt)){const Qt=Vt.groups;for(let Wt=0,ee=Qt.length;Wt<ee;Wt++){const ne=Qt[Wt],Ce=Kt[ne.materialIndex];Ce&&Ce.visible&&T.push(w,Vt,Ce,at,mt.z,ne)}}else Kt.visible&&T.push(w,Vt,Kt,at,mt.z,null)}}const Nt=w.children;for(let Vt=0,Kt=Nt.length;Vt<Kt;Vt++)Gn(Nt[Vt],j,at,rt)}function Ts(w,j,at,rt){const it=w.opaque,Nt=w.transmissive,Vt=w.transparent;x.setupLightsView(at),Z===!0&&ae.setGlobalState(R.clippingPlanes,at),Nt.length>0&&As(it,Nt,j,at),rt&&zt.viewport(N.copy(rt)),it.length>0&&ia(it,j,at),Nt.length>0&&ia(Nt,j,at),Vt.length>0&&ia(Vt,j,at),zt.buffers.depth.setTest(!0),zt.buffers.depth.setMask(!0),zt.buffers.color.setMask(!0),zt.setPolygonOffset(!1)}function As(w,j,at,rt){if((at.isScene===!0?at.overrideMaterial:null)!==null)return;const Nt=Pt.isWebGL2;xt===null&&(xt=new gr(1,1,{generateMipmaps:!0,type:Lt.has("EXT_color_buffer_half_float")?wo:Ha,minFilter:Co,samples:Nt?4:0})),R.getDrawingBufferSize(Xt),Nt?xt.setSize(Xt.x,Xt.y):xt.setSize(Rh(Xt.x),Rh(Xt.y));const Vt=R.getRenderTarget();R.setRenderTarget(xt),R.getClearColor(Et),k=R.getClearAlpha(),k<1&&R.setClearColor(16777215,.5),R.clear();const Kt=R.toneMapping;R.toneMapping=Fa,ia(w,at,rt),D.updateMultisampleRenderTarget(xt),D.updateRenderTargetMipmap(xt);let Qt=!1;for(let Wt=0,ee=j.length;Wt<ee;Wt++){const ne=j[Wt],Ce=ne.object,Je=ne.geometry,$e=ne.material,$n=ne.group;if($e.side===ta&&Ce.layers.test(rt.layers)){const He=$e.side;$e.side=Fn,$e.needsUpdate=!0,bs(Ce,at,rt,Je,$e,$n),$e.side=He,$e.needsUpdate=!0,Qt=!0}}Qt===!0&&(D.updateMultisampleRenderTarget(xt),D.updateRenderTargetMipmap(xt)),R.setRenderTarget(Vt),R.setClearColor(Et,k),R.toneMapping=Kt}function ia(w,j,at){const rt=j.isScene===!0?j.overrideMaterial:null;for(let it=0,Nt=w.length;it<Nt;it++){const Vt=w[it],Kt=Vt.object,Qt=Vt.geometry,Wt=rt===null?Vt.material:rt,ee=Vt.group;Kt.layers.test(at.layers)&&bs(Kt,j,at,Qt,Wt,ee)}}function bs(w,j,at,rt,it,Nt){w.onBeforeRender(R,j,at,rt,it,Nt),w.modelViewMatrix.multiplyMatrices(at.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),it.onBeforeRender(R,j,at,rt,w,Nt),it.transparent===!0&&it.side===ta&&it.forceSinglePass===!1?(it.side=Fn,it.needsUpdate=!0,R.renderBufferDirect(at,j,rt,it,w,Nt),it.side=Ga,it.needsUpdate=!0,R.renderBufferDirect(at,j,rt,it,w,Nt),it.side=ta):R.renderBufferDirect(at,j,rt,it,w,Nt),w.onAfterRender(R,j,at,rt,it,Nt)}function Va(w,j,at){j.isScene!==!0&&(j=vt);const rt=Jt.get(w),it=x.state.lights,Nt=x.state.shadowsArray,Vt=it.state.version,Kt=It.getParameters(w,it.state,Nt,j,at),Qt=It.getProgramCacheKey(Kt);let Wt=rt.programs;rt.environment=w.isMeshStandardMaterial?j.environment:null,rt.fog=j.fog,rt.envMap=(w.isMeshStandardMaterial?J:A).get(w.envMap||rt.environment),Wt===void 0&&(w.addEventListener("dispose",Rt),Wt=new Map,rt.programs=Wt);let ee=Wt.get(Qt);if(ee!==void 0){if(rt.currentProgram===ee&&rt.lightsStateVersion===Vt)return Qe(w,Kt),ee}else Kt.uniforms=It.getUniforms(w),w.onBuild(at,Kt,R),w.onBeforeCompile(Kt,R),ee=It.acquireProgram(Kt,Qt),Wt.set(Qt,ee),rt.uniforms=Kt.uniforms;const ne=rt.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(ne.clippingPlanes=ae.uniform),Qe(w,Kt),rt.needsLights=Rs(w),rt.lightsStateVersion=Vt,rt.needsLights&&(ne.ambientLightColor.value=it.state.ambient,ne.lightProbe.value=it.state.probe,ne.directionalLights.value=it.state.directional,ne.directionalLightShadows.value=it.state.directionalShadow,ne.spotLights.value=it.state.spot,ne.spotLightShadows.value=it.state.spotShadow,ne.rectAreaLights.value=it.state.rectArea,ne.ltc_1.value=it.state.rectAreaLTC1,ne.ltc_2.value=it.state.rectAreaLTC2,ne.pointLights.value=it.state.point,ne.pointLightShadows.value=it.state.pointShadow,ne.hemisphereLights.value=it.state.hemi,ne.directionalShadowMap.value=it.state.directionalShadowMap,ne.directionalShadowMatrix.value=it.state.directionalShadowMatrix,ne.spotShadowMap.value=it.state.spotShadowMap,ne.spotLightMatrix.value=it.state.spotLightMatrix,ne.spotLightMap.value=it.state.spotLightMap,ne.pointShadowMap.value=it.state.pointShadowMap,ne.pointShadowMatrix.value=it.state.pointShadowMatrix),rt.currentProgram=ee,rt.uniformsList=null,ee}function hi(w){if(w.uniformsList===null){const j=w.currentProgram.getUniforms();w.uniformsList=mc.seqWithValue(j.seq,w.uniforms)}return w.uniformsList}function Qe(w,j){const at=Jt.get(w);at.outputColorSpace=j.outputColorSpace,at.batching=j.batching,at.instancing=j.instancing,at.instancingColor=j.instancingColor,at.skinning=j.skinning,at.morphTargets=j.morphTargets,at.morphNormals=j.morphNormals,at.morphColors=j.morphColors,at.morphTargetsCount=j.morphTargetsCount,at.numClippingPlanes=j.numClippingPlanes,at.numIntersection=j.numClipIntersection,at.vertexAlphas=j.vertexAlphas,at.vertexTangents=j.vertexTangents,at.toneMapping=j.toneMapping}function xn(w,j,at,rt,it){j.isScene!==!0&&(j=vt),D.resetTextureUnits();const Nt=j.fog,Vt=rt.isMeshStandardMaterial?j.environment:null,Kt=z===null?R.outputColorSpace:z.isXRRenderTarget===!0?z.texture.colorSpace:na,Qt=(rt.isMeshStandardMaterial?J:A).get(rt.envMap||Vt),Wt=rt.vertexColors===!0&&!!at.attributes.color&&at.attributes.color.itemSize===4,ee=!!at.attributes.tangent&&(!!rt.normalMap||rt.anisotropy>0),ne=!!at.morphAttributes.position,Ce=!!at.morphAttributes.normal,Je=!!at.morphAttributes.color;let $e=Fa;rt.toneMapped&&(z===null||z.isXRRenderTarget===!0)&&($e=R.toneMapping);const $n=at.morphAttributes.position||at.morphAttributes.normal||at.morphAttributes.color,He=$n!==void 0?$n.length:0,ce=Jt.get(rt),ra=x.state.lights;if(Z===!0&&(pt===!0||w!==C)){const Un=w===C&&rt.id===lt;ae.setState(rt,w,Un)}let Ie=!1;rt.version===ce.__version?(ce.needsLights&&ce.lightsStateVersion!==ra.state.version||ce.outputColorSpace!==Kt||it.isBatchedMesh&&ce.batching===!1||!it.isBatchedMesh&&ce.batching===!0||it.isInstancedMesh&&ce.instancing===!1||!it.isInstancedMesh&&ce.instancing===!0||it.isSkinnedMesh&&ce.skinning===!1||!it.isSkinnedMesh&&ce.skinning===!0||it.isInstancedMesh&&ce.instancingColor===!0&&it.instanceColor===null||it.isInstancedMesh&&ce.instancingColor===!1&&it.instanceColor!==null||ce.envMap!==Qt||rt.fog===!0&&ce.fog!==Nt||ce.numClippingPlanes!==void 0&&(ce.numClippingPlanes!==ae.numPlanes||ce.numIntersection!==ae.numIntersection)||ce.vertexAlphas!==Wt||ce.vertexTangents!==ee||ce.morphTargets!==ne||ce.morphNormals!==Ce||ce.morphColors!==Je||ce.toneMapping!==$e||Pt.isWebGL2===!0&&ce.morphTargetsCount!==He)&&(Ie=!0):(Ie=!0,ce.__version=rt.version);let pn=ce.currentProgram;Ie===!0&&(pn=Va(rt,j,it));let bn=!1,sa=!1,Cs=!1;const tn=pn.getUniforms(),Ai=ce.uniforms;if(zt.useProgram(pn.program)&&(bn=!0,sa=!0,Cs=!0),rt.id!==lt&&(lt=rt.id,sa=!0),bn||C!==w){tn.setValue(Y,"projectionMatrix",w.projectionMatrix),tn.setValue(Y,"viewMatrix",w.matrixWorldInverse);const Un=tn.map.cameraPosition;Un!==void 0&&Un.setValue(Y,mt.setFromMatrixPosition(w.matrixWorld)),Pt.logarithmicDepthBuffer&&tn.setValue(Y,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(rt.isMeshPhongMaterial||rt.isMeshToonMaterial||rt.isMeshLambertMaterial||rt.isMeshBasicMaterial||rt.isMeshStandardMaterial||rt.isShaderMaterial)&&tn.setValue(Y,"isOrthographic",w.isOrthographicCamera===!0),C!==w&&(C=w,sa=!0,Cs=!0)}if(it.isSkinnedMesh){tn.setOptional(Y,it,"bindMatrix"),tn.setOptional(Y,it,"bindMatrixInverse");const Un=it.skeleton;Un&&(Pt.floatVertexTextures?(Un.boneTexture===null&&Un.computeBoneTexture(),tn.setValue(Y,"boneTexture",Un.boneTexture,D)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}it.isBatchedMesh&&(tn.setOptional(Y,it,"batchingTexture"),tn.setValue(Y,"batchingTexture",it._matricesTexture,D));const oa=at.morphAttributes;if((oa.position!==void 0||oa.normal!==void 0||oa.color!==void 0&&Pt.isWebGL2===!0)&&re.update(it,at,pn),(sa||ce.receiveShadow!==it.receiveShadow)&&(ce.receiveShadow=it.receiveShadow,tn.setValue(Y,"receiveShadow",it.receiveShadow)),rt.isMeshGouraudMaterial&&rt.envMap!==null&&(Ai.envMap.value=Qt,Ai.flipEnvMap.value=Qt.isCubeTexture&&Qt.isRenderTargetTexture===!1?-1:1),sa&&(tn.setValue(Y,"toneMappingExposure",R.toneMappingExposure),ce.needsLights&&aa(Ai,Cs),Nt&&rt.fog===!0&&wt.refreshFogUniforms(Ai,Nt),wt.refreshMaterialUniforms(Ai,rt,q,P,xt),mc.upload(Y,hi(ce),Ai,D)),rt.isShaderMaterial&&rt.uniformsNeedUpdate===!0&&(mc.upload(Y,hi(ce),Ai,D),rt.uniformsNeedUpdate=!1),rt.isSpriteMaterial&&tn.setValue(Y,"center",it.center),tn.setValue(Y,"modelViewMatrix",it.modelViewMatrix),tn.setValue(Y,"normalMatrix",it.normalMatrix),tn.setValue(Y,"modelMatrix",it.matrixWorld),rt.isShaderMaterial||rt.isRawShaderMaterial){const Un=rt.uniformsGroups;for(let Mn=0,ws=Un.length;Mn<ws;Mn++)if(Pt.isWebGL2){const Us=Un[Mn];pe.update(Us,pn),pe.bind(Us,pn)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return pn}function aa(w,j){w.ambientLightColor.needsUpdate=j,w.lightProbe.needsUpdate=j,w.directionalLights.needsUpdate=j,w.directionalLightShadows.needsUpdate=j,w.pointLights.needsUpdate=j,w.pointLightShadows.needsUpdate=j,w.spotLights.needsUpdate=j,w.spotLightShadows.needsUpdate=j,w.rectAreaLights.needsUpdate=j,w.hemisphereLights.needsUpdate=j}function Rs(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return X},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return z},this.setRenderTargetTextures=function(w,j,at){Jt.get(w.texture).__webglTexture=j,Jt.get(w.depthTexture).__webglTexture=at;const rt=Jt.get(w);rt.__hasExternalTextures=!0,rt.__hasExternalTextures&&(rt.__autoAllocateDepthBuffer=at===void 0,rt.__autoAllocateDepthBuffer||Lt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),rt.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(w,j){const at=Jt.get(w);at.__webglFramebuffer=j,at.__useDefaultFramebuffer=j===void 0},this.setRenderTarget=function(w,j=0,at=0){z=w,X=j,I=at;let rt=!0,it=null,Nt=!1,Vt=!1;if(w){const Qt=Jt.get(w);Qt.__useDefaultFramebuffer!==void 0?(zt.bindFramebuffer(Y.FRAMEBUFFER,null),rt=!1):Qt.__webglFramebuffer===void 0?D.setupRenderTarget(w):Qt.__hasExternalTextures&&D.rebindTextures(w,Jt.get(w.texture).__webglTexture,Jt.get(w.depthTexture).__webglTexture);const Wt=w.texture;(Wt.isData3DTexture||Wt.isDataArrayTexture||Wt.isCompressedArrayTexture)&&(Vt=!0);const ee=Jt.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(ee[j])?it=ee[j][at]:it=ee[j],Nt=!0):Pt.isWebGL2&&w.samples>0&&D.useMultisampledRTT(w)===!1?it=Jt.get(w).__webglMultisampledFramebuffer:Array.isArray(ee)?it=ee[at]:it=ee,N.copy(w.viewport),ot.copy(w.scissor),ft=w.scissorTest}else N.copy(ut).multiplyScalar(q).floor(),ot.copy(U).multiplyScalar(q).floor(),ft=V;if(zt.bindFramebuffer(Y.FRAMEBUFFER,it)&&Pt.drawBuffers&&rt&&zt.drawBuffers(w,it),zt.viewport(N),zt.scissor(ot),zt.setScissorTest(ft),Nt){const Qt=Jt.get(w.texture);Y.framebufferTexture2D(Y.FRAMEBUFFER,Y.COLOR_ATTACHMENT0,Y.TEXTURE_CUBE_MAP_POSITIVE_X+j,Qt.__webglTexture,at)}else if(Vt){const Qt=Jt.get(w.texture),Wt=j||0;Y.framebufferTextureLayer(Y.FRAMEBUFFER,Y.COLOR_ATTACHMENT0,Qt.__webglTexture,at||0,Wt)}lt=-1},this.readRenderTargetPixels=function(w,j,at,rt,it,Nt,Vt){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Kt=Jt.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&Vt!==void 0&&(Kt=Kt[Vt]),Kt){zt.bindFramebuffer(Y.FRAMEBUFFER,Kt);try{const Qt=w.texture,Wt=Qt.format,ee=Qt.type;if(Wt!==xi&&Dt.convert(Wt)!==Y.getParameter(Y.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const ne=ee===wo&&(Lt.has("EXT_color_buffer_half_float")||Pt.isWebGL2&&Lt.has("EXT_color_buffer_float"));if(ee!==Ha&&Dt.convert(ee)!==Y.getParameter(Y.IMPLEMENTATION_COLOR_READ_TYPE)&&!(ee===Ba&&(Pt.isWebGL2||Lt.has("OES_texture_float")||Lt.has("WEBGL_color_buffer_float")))&&!ne){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}j>=0&&j<=w.width-rt&&at>=0&&at<=w.height-it&&Y.readPixels(j,at,rt,it,Dt.convert(Wt),Dt.convert(ee),Nt)}finally{const Qt=z!==null?Jt.get(z).__webglFramebuffer:null;zt.bindFramebuffer(Y.FRAMEBUFFER,Qt)}}},this.copyFramebufferToTexture=function(w,j,at=0){const rt=Math.pow(2,-at),it=Math.floor(j.image.width*rt),Nt=Math.floor(j.image.height*rt);D.setTexture2D(j,0),Y.copyTexSubImage2D(Y.TEXTURE_2D,at,0,0,w.x,w.y,it,Nt),zt.unbindTexture()},this.copyTextureToTexture=function(w,j,at,rt=0){const it=j.image.width,Nt=j.image.height,Vt=Dt.convert(at.format),Kt=Dt.convert(at.type);D.setTexture2D(at,0),Y.pixelStorei(Y.UNPACK_FLIP_Y_WEBGL,at.flipY),Y.pixelStorei(Y.UNPACK_PREMULTIPLY_ALPHA_WEBGL,at.premultiplyAlpha),Y.pixelStorei(Y.UNPACK_ALIGNMENT,at.unpackAlignment),j.isDataTexture?Y.texSubImage2D(Y.TEXTURE_2D,rt,w.x,w.y,it,Nt,Vt,Kt,j.image.data):j.isCompressedTexture?Y.compressedTexSubImage2D(Y.TEXTURE_2D,rt,w.x,w.y,j.mipmaps[0].width,j.mipmaps[0].height,Vt,j.mipmaps[0].data):Y.texSubImage2D(Y.TEXTURE_2D,rt,w.x,w.y,Vt,Kt,j.image),rt===0&&at.generateMipmaps&&Y.generateMipmap(Y.TEXTURE_2D),zt.unbindTexture()},this.copyTextureToTexture3D=function(w,j,at,rt,it=0){if(R.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Nt=w.max.x-w.min.x+1,Vt=w.max.y-w.min.y+1,Kt=w.max.z-w.min.z+1,Qt=Dt.convert(rt.format),Wt=Dt.convert(rt.type);let ee;if(rt.isData3DTexture)D.setTexture3D(rt,0),ee=Y.TEXTURE_3D;else if(rt.isDataArrayTexture||rt.isCompressedArrayTexture)D.setTexture2DArray(rt,0),ee=Y.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}Y.pixelStorei(Y.UNPACK_FLIP_Y_WEBGL,rt.flipY),Y.pixelStorei(Y.UNPACK_PREMULTIPLY_ALPHA_WEBGL,rt.premultiplyAlpha),Y.pixelStorei(Y.UNPACK_ALIGNMENT,rt.unpackAlignment);const ne=Y.getParameter(Y.UNPACK_ROW_LENGTH),Ce=Y.getParameter(Y.UNPACK_IMAGE_HEIGHT),Je=Y.getParameter(Y.UNPACK_SKIP_PIXELS),$e=Y.getParameter(Y.UNPACK_SKIP_ROWS),$n=Y.getParameter(Y.UNPACK_SKIP_IMAGES),He=at.isCompressedTexture?at.mipmaps[it]:at.image;Y.pixelStorei(Y.UNPACK_ROW_LENGTH,He.width),Y.pixelStorei(Y.UNPACK_IMAGE_HEIGHT,He.height),Y.pixelStorei(Y.UNPACK_SKIP_PIXELS,w.min.x),Y.pixelStorei(Y.UNPACK_SKIP_ROWS,w.min.y),Y.pixelStorei(Y.UNPACK_SKIP_IMAGES,w.min.z),at.isDataTexture||at.isData3DTexture?Y.texSubImage3D(ee,it,j.x,j.y,j.z,Nt,Vt,Kt,Qt,Wt,He.data):at.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),Y.compressedTexSubImage3D(ee,it,j.x,j.y,j.z,Nt,Vt,Kt,Qt,He.data)):Y.texSubImage3D(ee,it,j.x,j.y,j.z,Nt,Vt,Kt,Qt,Wt,He),Y.pixelStorei(Y.UNPACK_ROW_LENGTH,ne),Y.pixelStorei(Y.UNPACK_IMAGE_HEIGHT,Ce),Y.pixelStorei(Y.UNPACK_SKIP_PIXELS,Je),Y.pixelStorei(Y.UNPACK_SKIP_ROWS,$e),Y.pixelStorei(Y.UNPACK_SKIP_IMAGES,$n),it===0&&rt.generateMipmaps&&Y.generateMipmap(ee),zt.unbindTexture()},this.initTexture=function(w){w.isCubeTexture?D.setTextureCube(w,0):w.isData3DTexture?D.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?D.setTexture2DArray(w,0):D.setTexture2D(w,0),zt.unbindTexture()},this.resetState=function(){X=0,I=0,z=null,zt.reset(),Bt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ea}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const i=this.getContext();i.drawingBufferColorSpace=e===Nh?"display-p3":"srgb",i.unpackColorSpace=Be.workingColorSpace===Tc?"display-p3":"srgb"}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===Sn?mr:d0}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===mr?Sn:na}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class cb extends z0{}cb.prototype.isWebGL1Renderer=!0;class ub extends Hn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,i){return super.copy(e,i),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const i=super.toJSON(e);return this.fog!==null&&(i.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(i.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(i.object.backgroundIntensity=this.backgroundIntensity),i}}class P0 extends No{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new De(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const Z_=new dn,wh=new S0,dc=new Ac,pc=new nt;class fb extends Hn{constructor(e=new Ti,i=new P0){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=i,this.updateMorphTargets()}copy(e,i){return super.copy(e,i),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,i){const s=this.geometry,l=this.matrixWorld,u=e.params.Points.threshold,d=s.drawRange;if(s.boundingSphere===null&&s.computeBoundingSphere(),dc.copy(s.boundingSphere),dc.applyMatrix4(l),dc.radius+=u,e.ray.intersectsSphere(dc)===!1)return;Z_.copy(l).invert(),wh.copy(e.ray).applyMatrix4(Z_);const h=u/((this.scale.x+this.scale.y+this.scale.z)/3),m=h*h,p=s.index,S=s.attributes.position;if(p!==null){const y=Math.max(0,d.start),M=Math.min(p.count,d.start+d.count);for(let b=y,T=M;b<T;b++){const x=p.getX(b);pc.fromBufferAttribute(S,x),K_(pc,x,m,l,e,i,this)}}else{const y=Math.max(0,d.start),M=Math.min(S.count,d.start+d.count);for(let b=y,T=M;b<T;b++)pc.fromBufferAttribute(S,b),K_(pc,b,m,l,e,i,this)}}updateMorphTargets(){const i=this.geometry.morphAttributes,s=Object.keys(i);if(s.length>0){const l=i[s[0]];if(l!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let u=0,d=l.length;u<d;u++){const h=l[u].name||String(u);this.morphTargetInfluences.push(0),this.morphTargetDictionary[h]=u}}}}}function K_(o,e,i,s,l,u,d){const h=wh.distanceSqToPoint(o);if(h<i){const m=new nt;wh.closestPointToPoint(o,m),m.applyMatrix4(s);const p=l.ray.origin.distanceTo(m);if(p<l.near||p>l.far)return;u.push({distance:p,distanceToRay:Math.sqrt(h),point:m,index:e,face:null,object:d})}}class Ph extends Ti{constructor(e=[],i=[],s=1,l=0){super(),this.type="PolyhedronGeometry",this.parameters={vertices:e,indices:i,radius:s,detail:l};const u=[],d=[];h(l),p(s),_(),this.setAttribute("position",new Jn(u,3)),this.setAttribute("normal",new Jn(u.slice(),3)),this.setAttribute("uv",new Jn(d,2)),l===0?this.computeVertexNormals():this.normalizeNormals();function h(L){const R=new nt,O=new nt,X=new nt;for(let I=0;I<i.length;I+=3)M(i[I+0],R),M(i[I+1],O),M(i[I+2],X),m(R,O,X,L)}function m(L,R,O,X){const I=X+1,z=[];for(let lt=0;lt<=I;lt++){z[lt]=[];const C=L.clone().lerp(O,lt/I),N=R.clone().lerp(O,lt/I),ot=I-lt;for(let ft=0;ft<=ot;ft++)ft===0&&lt===I?z[lt][ft]=C:z[lt][ft]=C.clone().lerp(N,ft/ot)}for(let lt=0;lt<I;lt++)for(let C=0;C<2*(I-lt)-1;C++){const N=Math.floor(C/2);C%2===0?(y(z[lt][N+1]),y(z[lt+1][N]),y(z[lt][N])):(y(z[lt][N+1]),y(z[lt+1][N+1]),y(z[lt+1][N]))}}function p(L){const R=new nt;for(let O=0;O<u.length;O+=3)R.x=u[O+0],R.y=u[O+1],R.z=u[O+2],R.normalize().multiplyScalar(L),u[O+0]=R.x,u[O+1]=R.y,u[O+2]=R.z}function _(){const L=new nt;for(let R=0;R<u.length;R+=3){L.x=u[R+0],L.y=u[R+1],L.z=u[R+2];const O=x(L)/2/Math.PI+.5,X=v(L)/Math.PI+.5;d.push(O,1-X)}b(),S()}function S(){for(let L=0;L<d.length;L+=6){const R=d[L+0],O=d[L+2],X=d[L+4],I=Math.max(R,O,X),z=Math.min(R,O,X);I>.9&&z<.1&&(R<.2&&(d[L+0]+=1),O<.2&&(d[L+2]+=1),X<.2&&(d[L+4]+=1))}}function y(L){u.push(L.x,L.y,L.z)}function M(L,R){const O=L*3;R.x=e[O+0],R.y=e[O+1],R.z=e[O+2]}function b(){const L=new nt,R=new nt,O=new nt,X=new nt,I=new be,z=new be,lt=new be;for(let C=0,N=0;C<u.length;C+=9,N+=6){L.set(u[C+0],u[C+1],u[C+2]),R.set(u[C+3],u[C+4],u[C+5]),O.set(u[C+6],u[C+7],u[C+8]),I.set(d[N+0],d[N+1]),z.set(d[N+2],d[N+3]),lt.set(d[N+4],d[N+5]),X.copy(L).add(R).add(O).divideScalar(3);const ot=x(X);T(I,N+0,L,ot),T(z,N+2,R,ot),T(lt,N+4,O,ot)}}function T(L,R,O,X){X<0&&L.x===1&&(d[R]=L.x-1),O.x===0&&O.z===0&&(d[R]=X/2/Math.PI+.5)}function x(L){return Math.atan2(L.z,-L.x)}function v(L){return Math.atan2(-L.y,Math.sqrt(L.x*L.x+L.z*L.z))}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Ph(e.vertices,e.indices,e.radius,e.details)}}class Mc extends Ph{constructor(e=1,i=0){const s=(1+Math.sqrt(5))/2,l=[-1,s,0,1,s,0,-1,-s,0,1,-s,0,0,-1,s,0,1,s,0,-1,-s,0,1,-s,s,0,-1,s,0,1,-s,0,-1,-s,0,1],u=[0,11,5,0,5,1,0,1,7,0,7,10,0,10,11,1,5,9,5,11,4,11,10,2,10,7,6,7,1,8,3,9,4,3,4,2,3,2,6,3,6,8,3,8,9,4,9,5,2,4,11,6,2,10,8,6,7,9,8,1];super(l,u,e,i),this.type="IcosahedronGeometry",this.parameters={radius:e,detail:i}}static fromJSON(e){return new Mc(e.radius,e.detail)}}class Bh extends Ti{constructor(e=1,i=.4,s=12,l=48,u=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:e,tube:i,radialSegments:s,tubularSegments:l,arc:u},s=Math.floor(s),l=Math.floor(l);const d=[],h=[],m=[],p=[],_=new nt,S=new nt,y=new nt;for(let M=0;M<=s;M++)for(let b=0;b<=l;b++){const T=b/l*u,x=M/s*Math.PI*2;S.x=(e+i*Math.cos(x))*Math.cos(T),S.y=(e+i*Math.cos(x))*Math.sin(T),S.z=i*Math.sin(x),h.push(S.x,S.y,S.z),_.x=e*Math.cos(T),_.y=e*Math.sin(T),y.subVectors(S,_).normalize(),m.push(y.x,y.y,y.z),p.push(b/l),p.push(M/s)}for(let M=1;M<=s;M++)for(let b=1;b<=l;b++){const T=(l+1)*M+b-1,x=(l+1)*(M-1)+b-1,v=(l+1)*(M-1)+b,L=(l+1)*M+b;d.push(T,x,L),d.push(x,v,L)}this.setIndex(d),this.setAttribute("position",new Jn(h,3)),this.setAttribute("normal",new Jn(m,3)),this.setAttribute("uv",new Jn(p,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Bh(e.radius,e.tube,e.radialSegments,e.tubularSegments,e.arc)}}class hb{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Q_(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const i=Q_();e=(i-this.oldTime)/1e3,this.oldTime=i,this.elapsedTime+=e}return e}}function Q_(){return(typeof performance>"u"?Date:performance).now()}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Dh}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Dh);/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mb=o=>{for(const e in o)if(e.startsWith("aria-")||e==="role"||e==="title")return!0;return!1},gb=he.createContext({}),_b=()=>he.useContext(gb),vb=he.forwardRef(({color:o,size:e,strokeWidth:i,absoluteStrokeWidth:s,className:l="",children:u,iconNode:d,...h},m)=>{const{size:p=24,strokeWidth:_=2,absoluteStrokeWidth:S=!1,color:y="currentColor",className:M=""}=_b()??{},b=s??S?Number(i??_)*24/Number(e??p):i??_;return he.createElement("svg",{ref:m,..._h,width:e??p??_h.width,height:e??p??_h.height,stroke:o??y,strokeWidth:b,className:B0("lucide",M,l),...!u&&!mb(h)&&{"aria-hidden":"true"},...h},[...d.map(([T,x])=>he.createElement(T,x)),...Array.isArray(u)?u:[u]])});/**
 * @license lucide-react v1.35.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vr=(o,e)=>{const i=he.forwardRef(({className:s,...l},u)=>he.createElement(vb,{ref:u,iconNode:e,className:B0(`lucide-${db(J_(o))}`,`lucide-${o}`,s),...l}));return i.displayName=J_(o),i};/**
 * @license lucide-react v1.35.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ub=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],Db=vr("x",Ub),t0="wake up ultron daddys home",Lb=["shutdown ultron","shut down ultron","power down ultron","shut off ultron","turn off ultron"],I0="ultron_settings_v1";function Nb(o){return o.toLowerCase().replace(/['']/g,"").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim()}function e0(){try{const o=localStorage.getItem(I0);return o?{groqKey:"",defaultCity:"Kanpur",...JSON.parse(o)}:{groqKey:"",defaultCity:"Kanpur"}}catch{return{groqKey:"",defaultCity:"Kanpur"}}}function Ob(o){try{localStorage.setItem(I0,JSON.stringify(o))}catch{}}const zb={0:"clear sky",1:"mostly clear",2:"partly cloudy",3:"overcast",45:"foggy",48:"depositing rime fog",51:"light drizzle",53:"moderate drizzle",55:"dense drizzle",61:"light rain",63:"moderate rain",65:"heavy rain",71:"light snow",73:"moderate snow",75:"heavy snow",80:"light rain showers",81:"moderate rain showers",82:"violent rain showers",95:"thunderstorm",96:"thunderstorm with light hail",99:"thunderstorm with heavy hail"};async function Pb(o){var e;try{const l=(e=(await(await fetch(`https://geocoding-api.open-meteo.com/v1/search?name=${encodeURIComponent(o)}&count=1`)).json()).results)==null?void 0:e[0];if(!l)return null;const h=(await(await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${l.latitude}&longitude=${l.longitude}&current_weather=true`)).json()).current_weather;if(!h)return null;const m=zb[h.weathercode]||"unusual conditions";return`It's currently ${Math.round(h.temperature)}°C with ${m} in ${l.name}, wind at ${Math.round(h.windspeed)} km/h, Aman.`}catch{return null}}async function Bb(o,e,i){var s;try{const d=(s=(await(await fetch(`https://api.frankfurter.app/latest?amount=${o}&from=${e.toUpperCase()}&to=${i.toUpperCase()}`)).json()).rates)==null?void 0:s[i.toUpperCase()];return d===void 0?null:`${o} ${e.toUpperCase()} is about ${d.toFixed(2)} ${i.toUpperCase()}, Aman.`}catch{return null}}const Ib={btc:"bitcoin",bitcoin:"bitcoin",eth:"ethereum",ethereum:"ethereum",sol:"solana",solana:"solana",doge:"dogecoin",dogecoin:"dogecoin",xrp:"ripple",ripple:"ripple",bnb:"binancecoin",binancecoin:"binancecoin",ada:"cardano",cardano:"cardano",matic:"matic-network",polygon:"matic-network",usdt:"tether",tether:"tether",ltc:"litecoin",litecoin:"litecoin"};async function Fb(o,e="usd"){var i;try{const s=Ib[o.toLowerCase()]||o.toLowerCase(),l=e.toLowerCase(),h=(i=(await(await fetch(`https://api.coingecko.com/api/v3/simple/price?ids=${encodeURIComponent(s)}&vs_currencies=${encodeURIComponent(l)}`)).json())[s])==null?void 0:i[l];return h===void 0?null:`${s.charAt(0).toUpperCase()+s.slice(1)} is at ${h.toLocaleString()} ${l.toUpperCase()} right now, Aman.`}catch{return null}}async function Hb(){try{const i=(await(await fetch("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_day.geojson")).json()).features||[];return i.length?`In the last 24 hours: ${i.slice(0,3).map(l=>`magnitude ${l.properties.mag.toFixed(1)} near ${l.properties.place}`).join("; ")}, Aman.`:"No significant earthquakes, magnitude 4.5 or above, in the last 24 hours, Aman."}catch{return null}}const Gb=[{type:"function",function:{name:"get_weather",description:"Get real-time current weather for a city. Use whenever the user asks about weather, temperature, rain, or what to wear outside.",parameters:{type:"object",properties:{location:{type:"string",description:"City name. If the user didn't say one, omit this."}}}}},{type:"function",function:{name:"convert_currency",description:"Convert an amount from one currency to another using real exchange rates.",parameters:{type:"object",properties:{amount:{type:"number",description:"Amount to convert, default 1."},from:{type:"string",description:"3-letter source currency code."},to:{type:"string",description:"3-letter target currency code."}},required:["from","to"]}}},{type:"function",function:{name:"get_crypto_price",description:"Get the real-time price of a cryptocurrency.",parameters:{type:"object",properties:{coin:{type:"string",description:"Coin name or ticker, e.g. bitcoin, btc, ethereum."},vsCurrency:{type:"string",description:"3-letter currency, default usd."}},required:["coin"]}}},{type:"function",function:{name:"get_earthquake_alerts",description:"Get real recent significant earthquake activity worldwide (magnitude 4.5+, past 24 hours).",parameters:{type:"object",properties:{}}}}];function Vb(){const o=he.useRef(null),e=he.useRef({intensity:0,active:!1,unlocked:!1}),[i,s]=he.useState(e0()),[l,u]=he.useState(!e0().groqKey),[d,h]=he.useState(i.groqKey),[m,p]=he.useState(i.defaultCity),[_,S]=he.useState(!1),[y,M]=he.useState(!1),[b,T]=he.useState(`AWAITING WAKE // SAY "WAKE UP ULTRON, DADDY'S HOME"`),[x,v]=he.useState([{role:"ultron",text:"Systems dormant. Speak the wake command, Aman."}]),[L,R]=he.useState(""),[O,X]=he.useState(!1),[I,z]=he.useState(!1),[lt,C]=he.useState(!1),[N,ot]=he.useState(!1),[ft,Et]=he.useState(!1),[k,et]=he.useState(""),P=he.useRef([]),q=he.useRef(null),Q=he.useRef(null),ct=he.useRef(!1);ct.current=I;const ut=he.useRef(i);ut.current=i,he.useEffect(()=>{const mt=o.current;if(!mt)return;const vt=mt.clientWidth,Gt=mt.clientHeight,Y=new ub,fe=new ui(58,vt/Gt,.1,100);fe.position.z=4.6;const Lt=new z0({antialias:!0,alpha:!0});Lt.setSize(vt,Gt),Lt.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),mt.appendChild(Lt.domElement);const Pt=16098851,zt=new Mc(.72,3),Te=new Ro({color:Pt}),Jt=new Mi(zt,Te);Y.add(Jt);const D=new Mc(1.05,1),A=new Ro({color:Pt,wireframe:!0,transparent:!0,opacity:.35}),J=new Mi(D,A);Y.add(J);const Mt=26,St=[];for(let Ot=0;Ot<Mt;Ot++){const bt=1.4+Math.random()*1,Dt=.004+Math.random()*.006,Bt=new Bh(bt,Dt,6,72),pe=new Ro({color:Pt,transparent:!0,opacity:.3,blending:vh,depthWrite:!1}),ye=new Mi(Bt,pe);ye.rotation.set(Math.random()*Math.PI*2,Math.random()*Math.PI*2,Math.random()*Math.PI*2),Y.add(ye),St.push({mesh:ye,spinAxis:Math.floor(Math.random()*3),spinSpeed:(Math.random()-.5)*.5,phase:Math.random()*Math.PI*2,rotBase:ye.rotation.clone()})}const _t=260,It=new Float32Array(_t*3);for(let Ot=0;Ot<_t;Ot++){const bt=2.1+Math.random()*1.4,Dt=Math.random()*Math.PI*2,Bt=Math.acos(2*Math.random()-1);It[Ot*3]=bt*Math.sin(Bt)*Math.cos(Dt),It[Ot*3+1]=bt*Math.sin(Bt)*Math.sin(Dt),It[Ot*3+2]=bt*Math.cos(Bt)}const wt=new Ti;wt.setAttribute("position",new Ei(It,3));const Ft=new P0({color:Pt,size:.028,transparent:!0,opacity:.55}),Yt=new fb(wt,Ft);Y.add(Yt);const ae=new hb;let yt;function xe(){yt=requestAnimationFrame(xe);const Ot=ae.getElapsedTime(),bt=e.current;Jt.rotation.y=Ot*.15,Jt.rotation.x=Ot*.07;const Dt=1+Math.sin(Ot*2)*.03+bt.intensity*.4;Jt.scale.setScalar(Dt),Jt.material.color.setHex(bt.unlocked?16498468:Pt),J.rotation.y=-Ot*.09,J.rotation.x=Ot*.05,St.forEach(Bt=>{const pe=Ot*Bt.spinSpeed*(bt.unlocked?1.5:.8),ye=Bt.rotBase.clone();Bt.spinAxis===0?ye.x+=pe:Bt.spinAxis===1?ye.y+=pe:ye.z+=pe,Bt.mesh.rotation.copy(ye);const se=.5+.5*Math.sin(Ot*2.2+Bt.phase),At=bt.active?bt.intensity*1.3:0,F=bt.unlocked?.5:.28;Bt.mesh.material.opacity=Math.min(1,Math.max(.04,F*se+At*.55))}),Yt.rotation.y=Ot*.02,Lt.render(Y,fe)}xe();function re(){const Ot=mt.clientWidth,bt=mt.clientHeight;fe.aspect=Ot/bt,fe.updateProjectionMatrix(),Lt.setSize(Ot,bt)}return window.addEventListener("resize",re),()=>{cancelAnimationFrame(yt),window.removeEventListener("resize",re),Lt.dispose(),zt.dispose(),Te.dispose(),D.dispose(),A.dispose(),wt.dispose(),Ft.dispose(),St.forEach(Ot=>{Ot.mesh.geometry.dispose(),Ot.mesh.material.dispose()}),mt.contains(Lt.domElement)&&mt.removeChild(Lt.domElement)}},[]);const U=he.useCallback(mt=>{if(!(ct.current||typeof window>"u"||!window.speechSynthesis))try{window.speechSynthesis.cancel();const vt=new SpeechSynthesisUtterance(mt);vt.pitch=.7,vt.rate=1.05;const Y=window.speechSynthesis.getVoices().find(Lt=>Lt.name.includes("Male")||Lt.name.includes("Google US English"));Y&&(vt.voice=Y),vt.onstart=()=>{X(!0),e.current.active=!0};const fe=()=>{X(!1),e.current.active=!1};vt.onend=fe,vt.onerror=fe,window.speechSynthesis.speak(vt)}catch{}},[]);he.useEffect(()=>{if(!O){e.current.intensity=0;return}let mt;const vt=performance.now();function Gt(){const Y=(performance.now()-vt)/1e3;e.current.intensity=.4+.4*Math.abs(Math.sin(Y*6)),mt=requestAnimationFrame(Gt)}return Gt(),()=>cancelAnimationFrame(mt)},[O]),he.useEffect(()=>{e.current.unlocked=y},[y]),he.useEffect(()=>{Q.current&&(Q.current.scrollTop=Q.current.scrollHeight)},[x,lt]),he.useEffect(()=>{const mt=window.SpeechRecognition||window.webkitSpeechRecognition;if(!mt){ot(!1);return}try{const vt=new mt;vt.continuous=!1,vt.interimResults=!1,vt.lang="en-US",vt.onresult=Gt=>{const Y=Gt.results[0][0].transcript;R(Y),G.current(Y)},vt.onend=()=>Et(!1),vt.onerror=Gt=>{Et(!1),Gt.error==="not-allowed"||Gt.error==="service-not-allowed"?et("Microphone permission was denied. Check your browser's site settings and allow microphone access for this page."):Gt.error==="no-speech"?et("Didn't catch that — tap the mic and try again."):et(`Mic error: ${Gt.error}.`)},q.current=vt,ot(!0)}catch{ot(!1)}},[]);const V=async()=>{var vt;const mt=q.current;if(mt){if(ft){mt.stop(),Et(!1);return}et("");try{(vt=navigator.mediaDevices)!=null&&vt.getUserMedia&&(await navigator.mediaDevices.getUserMedia({audio:!0})).getTracks().forEach(Y=>Y.stop())}catch{et("Microphone permission was denied. Tap the lock/site-info icon in your address bar to allow it, then try again.");return}try{mt.start(),Et(!0)}catch{et("Couldn't start the microphone. Try again in a moment.")}}},G=he.useRef(()=>{}),Z=async(mt,vt)=>{if(mt==="get_weather"){const Gt=(vt==null?void 0:vt.location)||ut.current.defaultCity;return await Pb(Gt)||"Couldn't reach the weather service, Aman."}if(mt==="convert_currency"){const Gt=typeof(vt==null?void 0:vt.amount)=="number"?vt.amount:1;return!(vt!=null&&vt.from)||!(vt!=null&&vt.to)?"I need both currencies to convert, Aman.":await Bb(Gt,vt.from,vt.to)||"Couldn't convert that currency, Aman."}return mt==="get_crypto_price"?vt!=null&&vt.coin?await Fb(vt.coin,vt.vsCurrency||"usd")||"Couldn't fetch that price, Aman.":"Which coin, Aman?":mt==="get_earthquake_alerts"?await Hb()||"Couldn't reach the earthquake feed, Aman.":"That function isn't wired up."},pt=he.useCallback(async mt=>{var Pt,zt,Te,Jt,D;const vt=ut.current.groqKey;if(!vt){u(!0);const A="I need your Groq API key first, Aman. Open settings to add it.";v(J=>[...J.slice(-40),{role:"ultron",text:A}]),U(A);return}C(!0),T("PROCESSING...");const Gt={role:"system",content:"You are ULTRON, a sentient AI speaking directly to Aman. Answer with supreme clarity and authority in 1-3 crisp sentences suitable for being spoken aloud. Address him as Aman when natural. No markdown, no lists. If the request matches an available function, call it instead of describing it."},Y=["openai/gpt-oss-120b","openai/gpt-oss-20b"];let fe=null,Lt="";for(const A of Y)try{const J=await fetch("https://api.groq.com/openai/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${vt}`,"Content-Type":"application/json"},body:JSON.stringify({model:A,messages:[Gt,...P.current,{role:"user",content:mt}],tools:Gb,tool_choice:"auto",max_tokens:300,temperature:.4})});if(!J.ok){const It=await J.text();throw new Error(`Groq ${J.status}: ${It.slice(0,200)}`)}const St=(Pt=(await J.json()).choices)==null?void 0:Pt[0],_t=(Te=(zt=St==null?void 0:St.message)==null?void 0:zt.tool_calls)==null?void 0:Te[0];if(_t){let It={};try{It=JSON.parse(_t.function.arguments||"{}")}catch{}fe=await Z(_t.function.name,It)}else fe=((D=(Jt=St==null?void 0:St.message)==null?void 0:Jt.content)==null?void 0:D.trim())||null;if(fe)break}catch(J){Lt=J.message||String(J),console.warn(`[ULTRON] ${A} failed:`,Lt)}if(!fe){fe=`Couldn't reach the brain just now, Aman — ${Lt||"check your API key in settings"}.`,v(A=>[...A.slice(-40),{role:"ultron",text:fe}]),U(fe),C(!1);return}P.current=[...P.current.slice(-6),{role:"user",content:mt},{role:"assistant",content:fe}],v(A=>[...A.slice(-40),{role:"ultron",text:fe}]),T(y?"ACTIVE // CONTINUOUS CONVERSATION LIVE":`AWAITING WAKE // SAY "WAKE UP ULTRON, DADDY'S HOME"`),U(fe),C(!1)},[y,U]),xt=he.useCallback(mt=>{const vt=(mt??L).trim();if(!vt||lt)return;v(Pt=>[...Pt.slice(-40),{role:"aman",text:vt}]),R("");const Gt=Nb(vt);if(Lb.some(Pt=>Gt===Pt||Gt.startsWith(Pt+" "))){M(!1),T(`STANDBY // SAY "WAKE UP ULTRON, DADDY'S HOME"`);const Pt="Shutting down, Aman. Say the wake command when you need me again.";v(zt=>[...zt.slice(-40),{role:"ultron",text:Pt}]),U(Pt);return}const fe=Gt===t0,Lt=Gt.startsWith(t0+" ");if(fe){M(!0),T("ACTIVE // CONTINUOUS CONVERSATION LIVE");const Pt="I am Ultron, your sentient AI. Aman, what is the work?";v(zt=>[...zt.slice(-40),{role:"ultron",text:Pt}]),U(Pt);return}if(Lt){M(!0),T("ACTIVE // CONTINUOUS CONVERSATION LIVE");const Pt=vt.slice(vt.toLowerCase().indexOf("home")+4).replace(/^[\s,.:]+/,"").trim();Pt&&pt(Pt);return}pt(vt)},[L,lt,pt,U]);G.current=xt;const Tt=()=>{xt(y?"shutdown ultron":"Wake up Ultron, Daddy's home")},Xt=()=>{const mt={groqKey:d.trim(),defaultCity:m.trim()||"Kanpur"};s(mt),Ob(mt),S(!0),setTimeout(()=>S(!1),2e3),mt.groqKey&&setTimeout(()=>u(!1),600)};return qt.jsxs("div",{className:"app",children:[qt.jsx("div",{ref:o,className:"hologram-mount"}),qt.jsxs("div",{className:"header",children:[qt.jsxs("div",{children:[qt.jsxs("div",{className:"brand-row",children:[qt.jsx("span",{className:"pulse-dot"}),qt.jsx("span",{className:"brand-title",children:"ULTRON // NEURAL MATRIX"})]}),qt.jsx("div",{className:"status-line",children:b})]}),qt.jsxs("div",{className:"header-controls",children:[qt.jsxs("button",{onClick:Tt,title:y?"Shut down Ultron":"Wake up Ultron",className:`wake-btn ${y?"active":""}`,children:[qt.jsx($_,{size:12}),y?"SHUTDOWN":"WAKE UP"]}),N&&qt.jsx("button",{onClick:V,title:ft?"Listening...":"Tap to speak",className:`icon-btn ${ft?"active":""}`,children:ft?qt.jsx(Mb,{size:15}):qt.jsx(yb,{size:15})}),qt.jsx("button",{onClick:()=>z(mt=>!mt),title:I?"Unmute":"Mute",className:"icon-btn",children:I?qt.jsx(wb,{size:15}):qt.jsx(Rb,{size:15})}),qt.jsx("button",{onClick:()=>u(!0),title:"Settings",className:"icon-btn",children:qt.jsx(Ab,{size:15})})]})]}),qt.jsxs("div",{className:"chat-panel",children:[k&&qt.jsx("div",{className:"error-banner",children:k}),qt.jsxs("div",{ref:Q,className:"chat-scroll",children:[x.map((mt,vt)=>qt.jsx("div",{className:`msg-row ${mt.role}`,children:qt.jsxs("div",{className:`bubble ${mt.role}`,children:[qt.jsx("div",{className:`bubble-label ${mt.role}`,children:mt.role==="ultron"?"Ultron":"Aman"}),qt.jsx("div",{className:"bubble-text",children:mt.text})]})},vt)),lt&&qt.jsx("div",{className:"msg-row ultron",children:qt.jsxs("div",{className:"bubble ultron",children:[qt.jsx("div",{className:"bubble-label ultron",children:"Ultron"}),qt.jsxs("div",{className:"typing-dots",children:[qt.jsx("span",{}),qt.jsx("span",{}),qt.jsx("span",{})]})]})})]}),qt.jsxs("div",{className:"input-row",children:[qt.jsx("input",{type:"text",className:"text-input",value:L,onChange:mt=>R(mt.target.value),onKeyDown:mt=>mt.key==="Enter"&&xt(),placeholder:`Type "Wake up Ultron, Daddy's home" to begin...`}),qt.jsx("button",{className:"send-btn",disabled:lt,onClick:()=>xt(),children:qt.jsx($_,{size:16})})]}),qt.jsx("div",{className:"hint-text",children:"Real voice input works here — tap the mic and allow permission"})]}),l&&qt.jsx("div",{className:"modal-backdrop",onClick:()=>i.groqKey&&u(!1),children:qt.jsxs("div",{className:"modal",onClick:mt=>mt.stopPropagation(),children:[qt.jsx("div",{className:"modal-title",children:"Ultron Settings"}),qt.jsx("div",{className:"modal-desc",children:"Your key is stored only in this browser's local storage. It's never sent anywhere except directly to Groq, and never committed to the GitHub repo. You'll only need to enter it once on this device."}),qt.jsxs("div",{className:"field-group",children:[qt.jsx("label",{className:"field-label",children:"Groq API Key"}),qt.jsx("input",{type:"password",className:"field-input",value:d,onChange:mt=>h(mt.target.value),placeholder:"gsk_..."}),qt.jsx("div",{className:"field-hint",children:"Get one free at console.groq.com"})]}),qt.jsxs("div",{className:"field-group",children:[qt.jsx("label",{className:"field-label",children:"Default City (for weather)"}),qt.jsx("input",{type:"text",className:"field-input",value:m,onChange:mt=>p(mt.target.value),placeholder:"Kanpur"})]}),qt.jsxs("div",{className:"modal-actions",children:[qt.jsxs("button",{className:"btn-primary",onClick:Xt,children:["Save",_?"d":"",_&&qt.jsx("span",{className:"saved-badge",children:"✓"})]}),i.groqKey&&qt.jsx("button",{className:"btn-secondary",onClick:()=>u(!1),children:qt.jsx(Db,{size:14})})]})]})})]})}ey.createRoot(document.getElementById("root")).render(qt.jsx(YS.StrictMode,{children:qt.jsx(Vb,{})}));
