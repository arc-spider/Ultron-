 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var F0;function VS(){if(F0)return st;F0=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),p=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),d=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),S=Symbol.for("react.activity"),g=Symbol.iterator;function E(C){return C===null||typeof C!="object"?null:(C=g&&C[g]||C["@@iterator"],typeof C=="function"?C:null)}var T={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},w=Object.assign,y={};function x(C,V,ge){this.props=C,this.context=V,this.refs=y,this.updater=ge||T}x.prototype.isReactComponent={},x.prototype.setState=function(C,V){if(typeof C!="object"&&typeof C!="function"&&C!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,C,V,"setState")},x.prototype.forceUpdate=function(C){this.updater.enqueueForceUpdate(this,C,"forceUpdate")};function z(){}z.prototype=x.prototype;function H(C,V,ge){this.props=C,this.context=V,this.refs=y,this.updater=ge||T}var D=H.prototype=new z;D.constructor=H,w(D,x.prototype),D.isPureReactComponent=!0;var I=Array.isArray;function L(){}var O={H:null,A:null,T:null,S:null},b=Object.prototype.hasOwnProperty;function N(C,V,ge){var be=ge.ref;return{$$typeof:o,type:C,key:V,ref:be!==void 0?be:null,props:ge}}function Y(C,V){return N(C.type,V,C.props)}function k(C){return typeof C=="object"&&C!==null&&C.$$typeof===o}function J(C){var V={"=":"=0",":":"=2"};return"$"+C.replace(/[=:]/g,function(ge){return V[ge]})}var pe=/\/+/g;function Se(C,V){return typeof C=="object"&&C!==null&&C.key!=null?J(""+C.key):V.toString(36)}function j(C){switch(C.status){case"fulfilled":return C.value;case"rejected":throw C.reason;default:switch(typeof C.status=="string"?C.then(L,L):(C.status="pending",C.then(function(V){C.status==="pending"&&(C.status="fulfilled",C.value=V)},function(V){C.status==="pending"&&(C.status="rejected",C.reason=V)})),C.status){case"fulfilled":return C.value;case"rejected":throw C.reason}}throw C}function P(C,V,ge,be,Ce){var Q=typeof C;(Q==="undefined"||Q==="boolean")&&(C=null);var ve=!1;if(C===null)ve=!0;else switch(Q){case"bigint":case"string":case"number":ve=!0;break;case"object":switch(C.$$typeof){case o:case e:ve=!0;break;case v:return ve=C._init,P(ve(C._payload),V,ge,be,Ce)}}if(ve)return Ce=Ce(C),ve=be===""?"."+Se(C,0):be,I(Ce)?(ge="",ve!=null&&(ge=ve.replace(pe,"$&/")+"/"),P(Ce,V,ge,"",function(je){return je})):Ce!=null&&(k(Ce)&&(Ce=Y(Ce,ge+(Ce.key==null||C&&C.key===Ce.key?"":(""+Ce.key).replace(pe,"$&/")+"/")+ve)),V.push(Ce)),1;ve=0;var Ee=be===""?".":be+":";if(I(C))for(var De=0;De<C.length;De++)be=C[De],Q=Ee+Se(be,De),ve+=P(be,V,ge,Q,Ce);else if(De=E(C),typeof De=="function")for(C=De.call(C),De=0;!(be=C.next()).done;)be=be.value,Q=Ee+Se(be,De++),ve+=P(be,V,ge,Q,Ce);else if(Q==="object"){if(typeof C.then=="function")return P(j(C),V,ge,be,Ce);throw V=String(C),Error("Objects are not valid as a React child (found: "+(V==="[object Object]"?"object with keys {"+Object.keys(C).join(", ")+"}":V)+"). If you meant to render a collection of children, use an array instead.")}return ve}function F(C,V,ge){if(C==null)return C;var be=[],Ce=0;return P(C,be,"","",function(Q){return V.call(ge,Q,Ce++)}),be}function ee(C){if(C._status===-1){var V=C._result;V=V(),V.then(function(ge){(C._status===0||C._status===-1)&&(C._status=1,C._result=ge)},function(ge){(C._status===0||C._status===-1)&&(C._status=2,C._result=ge)}),C._status===-1&&(C._status=0,C._result=V)}if(C._status===1)return C._result.default;throw C._result}var _e=typeof reportError=="function"?reportError:function(C){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var V=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof C=="object"&&C!==null&&typeof C.message=="string"?String(C.message):String(C),error:C});if(!window.dispatchEvent(V))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",C);return}console.error(C)},le={map:F,forEach:function(C,V,ge){F(C,function(){V.apply(this,arguments)},ge)},count:function(C){var V=0;return F(C,function(){V++}),V},toArray:function(C){return F(C,function(V){return V})||[]},only:function(C){if(!k(C))throw Error("React.Children.only expected to receive a single React element child.");return C}};return st.Activity=S,st.Children=le,st.Component=x,st.Fragment=i,st.Profiler=l,st.PureComponent=H,st.StrictMode=s,st.Suspense=m,st.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=O,st.__COMPILER_RUNTIME={__proto__:null,c:function(C){return O.H.useMemoCache(C)}},st.cache=function(C){return function(){return C.apply(null,arguments)}},st.cacheSignal=function(){return null},st.cloneElement=function(C,V,ge){if(C==null)throw Error("The argument must be a React element, but you passed "+C+".");var be=w({},C.props),Ce=C.key;if(V!=null)for(Q in V.key!==void 0&&(Ce=""+V.key),V)!b.call(V,Q)||Q==="key"||Q==="__self"||Q==="__source"||Q==="ref"&&V.ref===void 0||(be[Q]=V[Q]);var Q=arguments.length-2;if(Q===1)be.children=ge;else if(1<Q){for(var ve=Array(Q),Ee=0;Ee<Q;Ee++)ve[Ee]=arguments[Ee+2];be.children=ve}return N(C.type,Ce,be)},st.createContext=function(C){return C={$$typeof:h,_currentValue:C,_currentValue2:C,_threadCount:0,Provider:null,Consumer:null},C.Provider=C,C.Consumer={$$typeof:c,_context:C},C},st.createElement=function(C,V,ge){var be,Ce={},Q=null;if(V!=null)for(be in V.key!==void 0&&(Q=""+V.key),V)b.call(V,be)&&be!=="key"&&be!=="__self"&&be!=="__source"&&(Ce[be]=V[be]);var ve=arguments.length-2;if(ve===1)Ce.children=ge;else if(1<ve){for(var Ee=Array(ve),De=0;De<ve;De++)Ee[De]=arguments[De+2];Ce.children=Ee}if(C&&C.defaultProps)for(be in ve=C.defaultProps,ve)Ce[be]===void 0&&(Ce[be]=ve[be]);return N(C,Q,Ce)},st.createRef=function(){return{current:null}},st.forwardRef=function(C){return{$$typeof:p,render:C}},st.isValidElement=k,st.lazy=function(C){return{$$typeof:v,_payload:{_status:-1,_result:C},_init:ee}},st.memo=function(C,V){return{$$typeof:d,type:C,compare:V===void 0?null:V}},st.startTransition=function(C){var V=O.T,ge={};O.T=ge;try{var be=C(),Ce=O.S;Ce!==null&&Ce(ge,be),typeof be=="object"&&be!==null&&typeof be.then=="function"&&be.then(L,_e)}catch(Q){_e(Q)}finally{V!==null&&ge.types!==null&&(V.types=ge.types),O.T=V}},st.unstable_useCacheRefresh=function(){return O.H.useCacheRefresh()},st.use=function(C){return O.H.use(C)},st.useActionState=function(C,V,ge){return O.H.useActionState(C,V,ge)},st.useCallback=function(C,V){return O.H.useCallback(C,V)},st.useContext=function(C){return O.H.useContext(C)},st.useDebugValue=function(){},st.useDeferredValue=function(C,V){return O.H.useDeferredValue(C,V)},st.useEffect=function(C,V){return O.H.useEffect(C,V)},st.useEffectEvent=function(C){return O.H.useEffectEvent(C)},st.useId=function(){return O.H.useId()},st.useImperativeHandle=function(C,V,ge){return O.H.useImperativeHandle(C,V,ge)},st.useInsertionEffect=function(C,V){return O.H.useInsertionEffect(C,V)},st.useLayoutEffect=function(C,V){return O.H.useLayoutEffect(C,V)},st.useMemo=function(C,V){return O.H.useMemo(C,V)},st.useOptimistic=function(C,V){return O.H.useOptimistic(C,V)},st.useReducer=function(C,V,ge){return O.H.useReducer(C,V,ge)},st.useRef=function(C){return O.H.useRef(C)},st.useState=function(C){return O.H.useState(C)},st.useSyncExternalStore=function(C,V,ge){return O.H.useSyncExternalStore(C,V,ge)},st.useTransition=function(){return O.H.useTransition()},st.version="19.2.8",st}var H0;function Gd(){return H0||(H0=1,fh.exports=VS()),fh.exports}var Mt=Gd();const kS=j_(Mt);var hh={exports:{}},Fo={},dh={exports:{}},ph={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var G0;function XS(){return G0||(G0=1,(function(o){function e(P,F){var ee=P.length;P.push(F);e:for(;0<ee;){var _e=ee-1>>>1,le=P[_e];if(0<l(le,F))P[_e]=F,P[ee]=le,ee=_e;else break e}}function i(P){return P.length===0?null:P[0]}function s(P){if(P.length===0)return null;var F=P[0],ee=P.pop();if(ee!==F){P[0]=ee;e:for(var _e=0,le=P.length,C=le>>>1;_e<C;){var V=2*(_e+1)-1,ge=P[V],be=V+1,Ce=P[be];if(0>l(ge,ee))be<le&&0>l(Ce,ge)?(P[_e]=Ce,P[be]=ee,_e=be):(P[_e]=ge,P[V]=ee,_e=V);else if(be<le&&0>l(Ce,ee))P[_e]=Ce,P[be]=ee,_e=be;else break e}}return F}function l(P,F){var ee=P.sortIndex-F.sortIndex;return ee!==0?ee:P.id-F.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var h=Date,p=h.now();o.unstable_now=function(){return h.now()-p}}var m=[],d=[],v=1,S=null,g=3,E=!1,T=!1,w=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,z=typeof clearTimeout=="function"?clearTimeout:null,H=typeof setImmediate<"u"?setImmediate:null;function D(P){for(var F=i(d);F!==null;){if(F.callback===null)s(d);else if(F.startTime<=P)s(d),F.sortIndex=F.expirationTime,e(m,F);else break;F=i(d)}}function I(P){if(w=!1,D(P),!T)if(i(m)!==null)T=!0,L||(L=!0,J());else{var F=i(d);F!==null&&j(I,F.startTime-P)}}var L=!1,O=-1,b=5,N=-1;function Y(){return y?!0:!(o.unstable_now()-N<b)}function k(){if(y=!1,L){var P=o.unstable_now();N=P;var F=!0;try{e:{T=!1,w&&(w=!1,z(O),O=-1),E=!0;var ee=g;try{t:{for(D(P),S=i(m);S!==null&&!(S.expirationTime>P&&Y());){var _e=S.callback;if(typeof _e=="function"){S.callback=null,g=S.priorityLevel;var le=_e(S.expirationTime<=P);if(P=o.unstable_now(),typeof le=="function"){S.callback=le,D(P),F=!0;break t}S===i(m)&&s(m),D(P)}else s(m);S=i(m)}if(S!==null)F=!0;else{var C=i(d);C!==null&&j(I,C.startTime-P),F=!1}}break e}finally{S=null,g=ee,E=!1}F=void 0}}finally{F?J():L=!1}}}var J;if(typeof H=="function")J=function(){H(k)};else if(typeof MessageChannel<"u"){var pe=new MessageChannel,Se=pe.port2;pe.port1.onmessage=k,J=function(){Se.postMessage(null)}}else J=function(){x(k,0)};function j(P,F){O=x(function(){P(o.unstable_now())},F)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(P){P.callback=null},o.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<P?Math.floor(1e3/P):5},o.unstable_getCurrentPriorityLevel=function(){return g},o.unstable_next=function(P){switch(g){case 1:case 2:case 3:var F=3;break;default:F=g}var ee=g;g=F;try{return P()}finally{g=ee}},o.unstable_requestPaint=function(){y=!0},o.unstable_runWithPriority=function(P,F){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var ee=g;g=P;try{return F()}finally{g=ee}},o.unstable_scheduleCallback=function(P,F,ee){var _e=o.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?_e+ee:_e):ee=_e,P){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=ee+le,P={id:v++,callback:F,priorityLevel:P,startTime:ee,expirationTime:le,sortIndex:-1},ee>_e?(P.sortIndex=ee,e(d,P),i(m)===null&&P===i(d)&&(w?(z(O),O=-1):w=!0,j(I,ee-_e))):(P.sortIndex=le,e(m,P),T||E||(T=!0,L||(L=!0,J()))),P},o.unstable_shouldYield=Y,o.unstable_wrapCallback=function(P){var F=g;return function(){var ee=g;g=F;try{return P.apply(this,arguments)}finally{g=ee}}}})(ph)),ph}var V0;function WS(){return V0||(V0=1,dh.exports=XS()),dh.exports}var mh={exports:{}},Nn={};/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function uT(o,e,i){const s=new Float32Array(Ns),l=new $(0,1,0);return new Bn({name:"SphericalGaussianBlur",defines:{n:Ns,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:au(),fragmentShader:`
...
`)}const m1={[ev]:"Linear",[tv]:"Reinhard",[nv]:"Cineon",[iv]:"ACESFilmic",[sv]:"AgX",[rv]:"Neutral",[av]:"Custom"};function g1(o,e){const i=m1[e];return i===void 0?(nt("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+o+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+o+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const zc=new $;function _1(){bt.getLuminanceCoefficients(zc);const o=zc.x.toFixed(4),e=zc.y.toFixed(4),i=zc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+x);const H=z+y+h,D=z+x+p,I=z_(l,l.VERTEX_SHADER,H),L=z_(l,l.FRAGMENT_SHADER,D);l.attachShader(w,I),l.attachShader(w,L),i.index0AttributeName!==void 0?l.bindAttribLocation(w,0,i.index0AttributeName):i.hasPositionAttribute===!0&&l.bindAttribLocation(w,0,"position"),l.linkProgram(w);function O(k){if(o.debug.checkShaderErrors){const J=l.getProgramInfoLog(w)||"",pe=l.getShaderInfoLog(I)||"",Se=l.getShaderInfoLog(L)||"",j=J.trim(),P=pe.trim(),F=Se.trim();let ee=!0,_e=!0;if(l.getProgramParameter(w,l.LINK_STATUS)===!1)if(ee=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,w,I,L);else{const le=F_(l,I,"vertex"),C=F_(l,L,"fragment");At("WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(w,l.VALIDATE_STATUS)+`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bA=o=>{for(const e in o)if(e.startsWith("aria-")||e==="role"||e==="title")return!0;return!1},TA=Mt.createContext({}),AA=()=>Mt.useContext(TA),RA=Mt.forwardRef(({color:o,size:e,strokeWidth:i,absoluteStrokeWidth:s,className:l="",children:c,iconNode:h,...p},m)=>{const{size:d=24,strokeWidth:v=2,absoluteStrokeWidth:S=!1,color:g="currentColor",className:E=""}=AA()??{},T=s??S?Number(i??v)*24/Number(e??d):i??v;return Mt.createElement("svg",{ref:m,...Qh,width:e??d??Qh.width,height:e??d??Qh.height,stroke:o??g,strokeWidth:T,className:zv("lucide",E,l),...!c&&!bA(p)&&{"aria-hidden":"true"},...p},[...h.map(([w,y])=>Mt.createElement(w,y)),...Array.isArray(c)?c:[c]])});/**
 * @license lucide-react v1.35.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const nl=(o,e)=>{const i=Mt.forwardRef(({className:s,...l},c)=>Mt.createElement(RA,{ref:c,iconNode:e,className:zv(`lucide-${yA(K_(o))}`,`lucide-${o}`,s),...l}));return i.displayName=K_(o),i};/**
 * @license lucide-react v1.35.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const PA=[["path",{d:"M11 4.702a.705.705 0 0 0-1.203-.498L6.413 7.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298z",key:"uqj9uw"}],["line",{x1:"22",x2:"16",y1:"9",y2:"15",key:"1ewh16"}],["line",{x1:"16",x2:"22",y1:"9",y2:"15",key:"5ykzw1"}]],IA=nl("volume-x",PA),zA="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",BA="Kanpur",J_="wake up jarvis",FA=["shutdown jarvis","shut down jarvis","power down jarvis","shut off jarvis","turn off jarvis"];function HA(o){return o.toLowerCase().replace(/['']/g,"").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim()}async function kr(o,e={},i=12e3){const s=new AbortController,l=setTimeout(()=>s.abort(),i);try{return await fetch(o,{...e,signal:s.signal})}finally{clearTimeout(l)}}const GA={0:"clear sky",1:"mostly clear",2:"partly cloudy",3:"overcast",45:"foggy",48:"depositing rime fog",51:"light drizzle",53:"moderate drizzle",55:"dense drizzle",61:"light rain",63:"moderate rain",65:"heavy rain",71:"light snow",73:"moderate snow",75:"heavy snow",80:"light rain showers",81:"moderate rain showers",82:"violent rain showers",95:"thunderstorm",96:"thunderstorm with light hail",99:"thunderstorm with heavy hail"};async function VA(o){var e;try{const l=(e=(await(await kr(`https://geocoding-api.open-meteo.com/v1/search?name=${encodeURIComponent(o)}&count=1`)).json()).results)==null?void 0:e[0];if(!l)return null;const p=(await(await kr(`https://api.open-meteo.com/v1/forecast?latitude=${l.latitude}&longitude=${l.longitude}&current_weather=true`)).json()).current_weather;if(!p)return null;const m=GA[p.weathercode]||"unusual conditions";return`It's currently ${Math.round(p.temperature)}°C with ${m} in ${l.name}, wind at ${Math.round(p.windspeed)} km/h, Aman.`}catch{return null}}async function kA(o,e,i){var s;try{const h=(s=(await(await kr(`https://api.frankfurter.app/latest?amount=${o}&from=${e.toUpperCase()}&to=${i.toUpperCase()}`)).json()).rates)==null?void 0:s[i.toUpperCase()];return h===void 0?null:`${o} ${e.toUpperCase()} is about ${h.toFixed(2)} ${i.toUpperCase()}, Aman.`}catch{return null}}const XA={btc:"bitcoin",bitcoin:"bitcoin",eth:"ethereum",ethereum:"ethereum",sol:"solana",solana:"solana",doge:"dogecoin",dogecoin:"dogecoin",xrp:"ripple",ripple:"ripple",bnb:"binancecoin",binancecoin:"binancecoin",ada:"cardano",cardano:"cardano",matic:"matic-network",polygon:"matic-network",usdt:"tether",tether:"tether",ltc:"litecoin",litecoin:"litecoin"};async function WA(o,e="usd"){var i;try{const s=XA[o.toLowerCase()]||o.toLowerCase(),l=e.toLowerCase(),p=(i=(await(await kr(`https://api.coingecko.com/api/v3/simple/price?ids=${encodeURIComponent(s)}&vs_currencies=${encodeURIComponent(l)}`)).json())[s])==null?void 0:i[l];return p===void 0?null:`${s.charAt(0).toUpperCase()+s.slice(1)} is at ${p.toLocaleString()} ${l.toUpperCase()} right now, Aman.`}catch{return null}}async function qA(){try{const i=(await(await kr("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_day.geojson")).json()).features||[];return i.length?`In the last 24 hours: ${i.slice(0,3).map(l=>`magnitude ${l.properties.mag.toFixed(1)} near ${l.properties.place}`).join("; ")}, Aman.`:"No significant earthquakes, magnitude 4.5 or above, in the last 24 hours, Aman."}catch{return null}}const YA=[{type:"function",function:{name:"get_weather",description:"Get real-time current weather for a city. Use whenever the user asks about weather, temperature, rain, or what to wear outside.",parameters:{type:"object",properties:{location:{type:"string",description:"City name. If the user didn't say one, omit this."}}}}},{type:"function",function:{name:"convert_currency",description:"Convert an amount from one currency to another using real exchange rates.",parameters:{type:"object",properties:{amount:{type:"number",description:"Amount to convert, default 1."},from:{type:"string",description:"3-letter source currency code."},to:{type:"string",description:"3-letter target currency code."}},required:["from","to"]}}},{type:"function",function:{name:"get_crypto_price",description:"Get the real-time price of a cryptocurrency.",parameters:{type:"object",properties:{coin:{type:"string",description:"Coin name or ticker, e.g. bitcoin, btc, ethereum."},vsCurrency:{type:"string",description:"3-letter currency, default usd."}},required:["coin"]}}},{type:"function",function:{name:"get_earthquake_alerts",description:"Get real recent significant earthquake activity worldwide (magnitude 4.5+, past 24 hours).",parameters:{type:"object",properties:{}}}}];function ZA(){const o=Mt.useRef(null),e=Mt.useRef({intensity:0,active:!1,unlocked:!1}),[i,s]=Mt.useState(!1),[l,c]=Mt.useState('AWAITING WAKE // SAY "WAKE UP JARVIS"'),[h,p]=Mt.useState([{role:"ultron",text:"Systems dormant. Speak the wake command, Aman."}]),[m,d]=Mt.useState(""),[v,S]=Mt.useState(!1),[g,E]=Mt.useState(!1),[T,w]=Mt.useState(!1),[y,x]=Mt.useState(!1),[z,H]=Mt.useState(!1),[D,I]=Mt.useState(""),L=Mt.useRef([]),O=Mt.useRef(null),b=Mt.useRef(null),N=Mt.useRef(!1);N.current=g,Mt.useEffect(()=>{const le=o.current;if(!le)return;const C=le.clientWidth,V=le.clientHeight,ge=new ZM,be=new Ei(50,C/V,.1,100);be.position.z=5.4;const Ce=new dA({antialias:!0,alpha:!0});Ce.setSize(C,V),Ce.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),le.appendChild(Ce.domElement);const Q=new xA(Ce);Q.addPass(new SA(ge,be));const ve=new Vr(new ot(C,V),1.1,.6,.15);Q.addPass(ve);const Ee=12744223,De=new Lr;ge.add(De);function je(Ne,G,Te,de,Re){const Ie=7+Math.floor(Math.random()*5);let Me=G,ke=de,Ve=new $(Math.cos(ke)*Me,Math.sin(ke)*Me,(Math.random()-.5)*.1);for(let Vt=0;Vt<Ie;Vt++){Me+=(Te-G)/Ie,ke+=(Math.random()-.5)*.4;const Ut=(Math.random()-.5)*.18*(Me/Te),Un=new $(Math.cos(ke)*Me,Math.sin(ke)*Me,Ut);Ne.push(Ve,Un),Re<2&&Vt>2&&Math.random()<.32&&je(Ne,Me,Me+(Te-G)*(.3+Math.random()*.3),ke+(Math.random()-.5)*1.4,Re+1),Ve=Un}}const Ge=[],Ot=70;for(let Ne=0;Ne<Ot;Ne++){const G=Ne/Ot*Math.PI*2+(Math.random()-.5)*.4;je(Ge,.32,1.45+Math.random()*.3,G,0)}const it=new vt(16773846),ut=new vt(12077087),ht=1.9,at=new Float32Array(Ge.length*3);for(let Ne=0;Ne<Ge.length;Ne++){const G=Ge[Ne],Te=Math.min(1,Math.sqrt(G.x*G.x+G.y*G.y)/ht),de=it.clone().lerp(ut,Te);at[Ne*3]=de.r,at[Ne*3+1]=de.g,at[Ne*3+2]=de.b}const qt=new $n().setFromPoints(Ge);qt.setAttribute("color",new Pi(at,3));const Kt=new Ev({vertexColors:!0,transparent:!0,opacity:.85,blending:Pr,depthWrite:!1}),$t=new sy(qt,Kt);De.add($t);const en=new jd(.2,32),Pt=new Sa({color:0}),Qt=new In(en,Pt);Qt.position.z=.03,De.add(Qt);const W=new Nr(.22,.012,6,48),Dt=new Sa({color:16766617,transparent:!0,opacity:.9,blending:Pr,depthWrite:!1}),yt=new In(W,Dt);yt.position.z=.025,De.add(yt);const U=new Nr(1.7,.055,8,100),M=new Sa({color:Ee,transparent:!0,opacity:.85}),K=new In(U,M);De.add(K);const se=new Nr(1.78,.035,8,100),he=new Sa({color:Ee,transparent:!0,opacity:.55}),Ae=new In(se,he);Ae.rotation.x=.2,Ae.rotation.y=.08,Ae.position.x=-.05,De.add(Ae);const Ue=new Nr(1.95,.012,6,100),ue=new Sa({color:Ee,transparent:!0,opacity:.5,blending:Pr,depthWrite:!1}),fe=new In(Ue,ue);fe.rotation.x=1.15,fe.rotation.z=.3,De.add(fe);const we=new Lr,Fe=64;for(let Ne=0;Ne<Fe;Ne++){if(Math.random()<.25)continue;const G=Ne/Fe*Math.PI*2,Te=new Wr(.035,.1,.02),de=new Sa({color:16766617,transparent:!0,opacity:.8}),Re=new In(Te,de);Re.position.set(Math.cos(G)*1.75,Math.sin(G)*1.75,0),Re.rotation.z=G,we.add(Re)}De.add(we);const Oe=new _y;let Le;function Ke(){Le=requestAnimationFrame(Ke);const Ne=Oe.getElapsedTime(),G=e.current;De.rotation.z=Ne*.06,De.rotation.y=Math.sin(Ne*.15)*.08;const Te=1+Math.sin(Ne*2)*.02+G.intensity*.15;De.scale.setScalar(Te);const de=.75+.25*Math.sin(Ne*3),Re=G.active?G.intensity*.5:0;Kt.opacity=Math.min(1,.7*de+Re),ve.strength=1.1+(G.unlocked?.3:0)+Re*.6,K.rotation.z=-Ne*.03,Ae.rotation.z=Ne*.04,fe.rotation.y=Ne*.05,yt.rotation.z=Ne*.15,we.rotation.z=-Ne*.03,Q.render()}Ke();function Qe(){const Ne=le.clientWidth,G=le.clientHeight;be.aspect=Ne/G,be.updateProjectionMatrix(),Ce.setSize(Ne,G),Q.setSize(Ne,G)}return window.addEventListener("resize",Qe),()=>{cancelAnimationFrame(Le),window.removeEventListener("resize",Qe),Ce.dispose(),qt.dispose(),Kt.dispose(),en.dispose(),Pt.dispose(),W.dispose(),Dt.dispose(),U.dispose(),M.dispose(),se.dispose(),he.dispose(),Ue.dispose(),ue.dispose(),we.children.forEach(Ne=>{Ne.geometry.dispose(),Ne.material.dispose()}),le.contains(Ce.domElement)&&le.removeChild(Ce.domElement)}},[]);const Y=Mt.useCallback(le=>{if(!(N.current||typeof window>"u"||!window.speechSynthesis))try{window.speechSynthesis.cancel();const C=new SpeechSynthesisUtterance(le);C.pitch=.7,C.rate=1.05;const ge=window.speechSynthesis.getVoices().find(Ce=>Ce.name.includes("Male")||Ce.name.includes("Google US English"));ge&&(C.voice=ge),C.onstart=()=>{S(!0),e.current.active=!0};const be=()=>{S(!1),e.current.active=!1};C.onend=be,C.onerror=be,window.speechSynthesis.speak(C)}catch{}},[]);Mt.useEffect(()=>{if(!v){e.current.intensity=0;return}let le;const C=performance.now();function V(){const ge=(performance.now()-C)/1e3;e.current.intensity=.4+.4*Math.abs(Math.sin(ge*6)),le=requestAnimationFrame(V)}return V(),()=>cancelAnimationFrame(le)},[v]),Mt.useEffect(()=>{e.current.unlocked=i},[i]),Mt.useEffect(()=>{b.current&&(b.current.scrollTop=b.current.scrollHeight)},[h,T]);const k=Mt.useRef(!1),J=Mt.useRef(!1);Mt.useEffect(()=>{const le=window.SpeechRecognition||window.webkitSpeechRecognition;if(!le){x(!1);return}try{const C=new le;C.continuous=!0,C.interimResults=!1,C.lang="en-US",C.onresult=V=>{const ge=V.results[V.results.length-1];if(!ge.isFinal)return;const be=ge[0].transcript;d(be),Se.current(be)},C.onend=()=>{k.current&&!J.current&&setTimeout(()=>{if(k.current&&!J.current)try{C.start()}catch{}},250)},C.onerror=V=>{V.error==="not-allowed"||V.error==="service-not-allowed"?(k.current=!1,H(!1),I("Microphone permission was denied. Check your browser's site settings and allow microphone access for this page.")):V.error==="no-speech"||V.error==="aborted"||I(`Mic error: ${V.error}.`)},O.current=C,x(!0)}catch{x(!1)}},[]),Mt.useEffect(()=>{J.current=v;const le=O.current;if(!(!le||!k.current))if(v)try{le.stop()}catch{}else setTimeout(()=>{if(k.current&&!J.current)try{le.start()}catch{}},300)},[v]);const pe=async()=>{var C;const le=O.current;if(le){if(z){k.current=!1,H(!1);try{le.stop()}catch{}return}I("");try{(C=navigator.mediaDevices)!=null&&C.getUserMedia&&(await navigator.mediaDevices.getUserMedia({audio:!0})).getTracks().forEach(ge=>ge.stop())}catch{I("Microphone permission was denied. Tap the lock/site-info icon in your address bar to allow it, then try again.");return}try{k.current=!0,le.start(),H(!0)}catch{I("Couldn't start the microphone. Try again in a moment.")}}},Se=Mt.useRef(()=>{}),j=async(le,C)=>{if(le==="get_weather"){const V=(C==null?void 0:C.location)||BA;return await VA(V)||"Couldn't reach the weather service, Aman."}if(le==="convert_currency"){const V=typeof(C==null?void 0:C.amount)=="number"?C.amount:1;return!(C!=null&&C.from)||!(C!=null&&C.to)?"I need both currencies to convert, Aman.":await kA(V,C.from,C.to)||"Couldn't convert that currency, Aman."}return le==="get_crypto_price"?C!=null&&C.coin?await WA(C.coin,C.vsCurrency||"usd")||"Couldn't fetch that price, Aman.":"Which coin, Aman?":le==="get_earthquake_alerts"?await qA()||"Couldn't reach the earthquake feed, Aman.":"That function isn't wired up."},P=async(le,C)=>{var Ce,Q,ve,Ee,De;const V={role:"system",content:"You are JARVIS, a sentient AI speaking directly to Aman. Answer with supreme clarity and authority in 1-3 crisp sentences suitable for being spoken aloud. Address him as Aman when natural. No markdown, no lists. If the request matches an available function, call it instead of describing it."},ge=["openai/gpt-oss-120b","openai/gpt-oss-20b"];let be="";for(const je of ge)try{const Ge=await kr("https://api.groq.com/openai/v1/chat/completions",{method:"POST",headers:{Authorization:`Bearer ${C}`,"Content-Type":"application/json"},body:JSON.stringify({model:je,messages:[V,...L.current,{role:"user",content:le}],tools:YA,tool_choice:"auto",max_tokens:300,temperature:.4})});if(!Ge.ok){const at=await Ge.text();throw new Error(`Groq ${Ge.status}: ${at.slice(0,200)}`)}const it=(Ce=(await Ge.json()).choices)==null?void 0:Ce[0],ut=(ve=(Q=it==null?void 0:it.message)==null?void 0:Q.tool_calls)==null?void 0:ve[0];if(ut){let at={};try{at=JSON.parse(ut.function.arguments||"{}")}catch{}return{reply:await j(ut.function.name,at),error:""}}const ht=(De=(Ee=it==null?void 0:it.message)==null?void 0:Ee.content)==null?void 0:De.trim();if(ht)return{reply:ht,error:""}}catch(Ge){be=Ge.name==="AbortError"?`${je} timed out (12s) — slow connection`:Ge.message||String(Ge),console.warn(`[JARVIS] Groq ${je} failed:`,be)}return{reply:null,error:be}},F=Mt.useCallback(async le=>{w(!0),c("PROCESSING...");const C=await P(le,zA);let V=C.reply;if(!V){V=`Couldn't reach the brain just now, Aman — ${C.error||"unknown error"}.`,p(ge=>[...ge.slice(-40),{role:"ultron",text:V}]),Y(V),w(!1);return}L.current=[...L.current.slice(-6),{role:"user",content:le},{role:"assistant",content:V}],p(ge=>[...ge.slice(-40),{role:"ultron",text:V}]),c(i?"ACTIVE // CONTINUOUS CONVERSATION LIVE":'AWAITING WAKE // SAY "WAKE UP JARVIS"'),Y(V),w(!1)},[i,Y]),ee=Mt.useCallback(le=>{const C=(le??m).trim();if(!C||T)return;p(Q=>[...Q.slice(-40),{role:"aman",text:C}]),d("");const V=HA(C);if(FA.some(Q=>V===Q||V.startsWith(Q+" "))){s(!1),c('STANDBY // SAY "WAKE UP JARVIS"');const Q="Shutting down, Aman. Say the wake command when you need me again.";p(ve=>[...ve.slice(-40),{role:"ultron",text:Q}]),Y(Q);return}const be=V===J_,Ce=V.startsWith(J_+" ");if(be){s(!0),c("ACTIVE // CONTINUOUS CONVERSATION LIVE");const Q="I am JARVIS, your sentient AI. Aman, what is the work?";p(ve=>[...ve.slice(-40),{role:"ultron",text:Q}]),Y(Q);return}if(Ce){s(!0),c("ACTIVE // CONTINUOUS CONVERSATION LIVE");const Q=C.slice(C.toLowerCase().indexOf("jarvis")+6).replace(/^[\s,.:]+/,"").trim();Q&&F(Q);return}F(C)},[m,T,F,Y]);Se.current=ee;const _e=()=>{ee(i?"shutdown jarvis":"Wake up JARVIS")};return pt.jsxs("div",{className:"app",children:[pt.jsx("div",{ref:o,className:"hologram-mount"}),pt.jsxs("div",{className:"header",children:[pt.jsxs("div",{children:[pt.jsxs("div",{className:"brand-row",children:[pt.jsx("span",{className:"pulse-dot"}),pt.jsx("span",{className:"brand-title",children:"JARVIS // NEURAL MATRIX"})]}),pt.jsx("div",{className:"status-line",children:l})]}),pt.jsxs("div",{className:"header-controls",children:[pt.jsxs("button",{onClick:_e,title:i?"Shut down JARVIS":"Wake up JARVIS",className:`wake-btn ${i?"active":""}`,children:[pt.jsx(Q_,{size:12}),i?"SHUTDOWN":"WAKE UP"]}),y&&pt.jsx("button",{onClick:pe,title:z?"Mic always on — tap to turn off":"Tap to turn mic always-on",className:`icon-btn ${z?"active":""}`,children:z?pt.jsx(UA,{size:15}):pt.jsx(wA,{size:15})}),pt.jsx("button",{onClick:()=>E(le=>!le),title:g?"Unmute":"Mute",className:"icon-btn",children:g?pt.jsx(IA,{size:15}):pt.jsx(OA,{size:15})})]})]}),pt.jsxs("div",{className:"chat-panel",children:[D&&pt.jsx("div",{className:"error-banner",children:D}),pt.jsxs("div",{ref:b,className:"chat-scroll",children:[h.map((le,C)=>pt.jsx("div",{className:`msg-row ${le.role}`,children:pt.jsxs("div",{className:`bubble ${le.role}`,children:[pt.jsx("div",{className:`bubble-label ${le.role}`,children:le.role==="ultron"?"JARVIS":"Aman"}),pt.jsx("div",{className:"bubble-text",children:le.text})]})},C)),T&&pt.jsx("div",{className:"msg-row ultron",children:pt.jsxs("div",{className:"bubble ultron",children:[pt.jsx("div",{className:"bubble-label ultron",children:"JARVIS"}),pt.jsxs("div",{className:"typing-dots",children:[pt.jsx("span",{}),pt.jsx("span",{}),pt.jsx("span",{})]})]})})]}),pt.jsxs("div",{className:"input-row",children:[pt.jsx("input",{type:"text",className:"text-input",value:m,onChange:le=>d(le.target.value),onKeyDown:le=>le.key==="Enter"&&ee(),placeholder:'Type "Wake up JARVIS" to begin...'}),pt.jsx("button",{className:"send-btn",disabled:T,onClick:()=>ee(),children:pt.jsx(Q_,{size:16})})]}),pt.jsx("div",{className:"hint-text",children:"Tap the mic once to turn it always-on — then just talk, no need to tap again"})]})]})}JS.createRoot(document.getElementById("root")).render(pt.jsx(kS.StrictMode,{children:pt.jsx(ZA,{})}));
